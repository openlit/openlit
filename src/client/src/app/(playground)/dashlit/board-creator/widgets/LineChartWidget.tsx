...
const LineChartWidgetComponent: React.FC<LineChartProps> = ({ widget }) => {
  return (
    <div className="flex flex-col h-full">
      <div className="text-sm text-muted-foreground mb-2">{widget.description}</div>
      <div className="flex-grow">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={widget.data} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
            ...
            <Line
              ...
              stroke={CHART_COLORS[widget.properties.color as keyof typeof CHART_COLORS][0]}
              activeDot={{ r: 8 }}
            />
          </LineChart>
        </ResponsiveContainer>
