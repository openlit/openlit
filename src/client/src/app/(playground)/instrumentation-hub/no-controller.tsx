...
const INSTALL_COMMANDS: Record<TabId, string[]> = {
	linux: [
		...
		"# Edit /etc/openlit-controller/config.yaml to set your OpenLIT URL",
		"sudo systemctl start openlit-controller",
	],
	docker: [
		"docker run -d --privileged --pid=host \\",
		"  -e OPENLIT_URL=http://<OPENLIT_HOST>:3000 \\",
		"  -p 4321:4321 \\",
		"  ghcr.io/openlit/openlit-controller:latest",
	],
	kubernetes: [
		"helm repo add openlit https://openlit.github.io/helm",
		"helm install openlit-controller openlit/openlit-controller \\",
