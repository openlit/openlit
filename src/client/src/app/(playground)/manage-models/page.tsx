	...
	return (
		<div className="flex flex-col h-full w-full overflow-hidden">
			<div className="shrink-0">
				<FeaturePageHeader eyebrow={m.SIDEBAR_CONFIGURATION} title={m.OPENGROUND_MANAGE_MODELS} icon={<SettingsIcon className="h-4 w-4" />} tone="border-violet-200 bg-violet-50 text-violet-700 dark:border-violet-900/70 dark:bg-violet-950/40 dark:text-violet-300" actions={<div className="flex items-center gap-2">
					<Tooltip>
						<TooltipTrigger>
							<Button
								variant="outline"
			...
			<div className="flex flex-col grow overflow-hidden p-4">
				<div className="flex flex-col w-full h-full border border-stone-200 dark:border-stone-800 rounded-md">
					{/* SDK Pricing URL bar */}
					{pricingUrl && (
						<div className="flex items-center gap-3 px-4 py-2.5 bg-stone-50 dark:bg-stone-950 border-b border-stone-200 dark:border-stone-800 shrink-0 rounded-t-md">
