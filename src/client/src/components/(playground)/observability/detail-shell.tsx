export default function DetailShell({
	...
	return (
		<div className="flex flex-col w-full h-full overflow-auto rounded-md border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-950">
			<div
				className={`sticky top-0 z-10 flex flex-col border-b border-stone-200 bg-white/95 shadow-sm shadow-stone-200/40 backdrop-blur dark:border-stone-800 dark:bg-stone-950/95 dark:shadow-black/20 ${compact ? "gap-2 px-3 py-2" : "gap-3 px-4 py-3"}`}
			>
				<div
			...
			<div className={`flex flex-col ${compact ? "gap-2 p-2" : "gap-4 p-4"}`}>
				{children}
			</div>
		</div>
	);
