...
export default function AddEditDialog({
	...
	initialItemType?: DashlitItemType;
	onSave: (title: string, description: string, type: DashlitItemType) => void;
	onCancel: () => void;
}) {
	const handleSubmit: FormBuilderEvent = useCallback((event, formdata) => {
		event.preventDefault();
		onSave(formdata.title, formdata.description, formdata.type as DashlitItemType);
	}, [onSave]);
