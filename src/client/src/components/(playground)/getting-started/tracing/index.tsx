    ...
    <div className="flex flex-col items-center p-8 w-full">
      <div className="w-full">
        ...
        <p className="text-center text-md mb-8 text-stone-500 dark:text-stone-500">
          OpenTelemetry-native auto-instrumentation to trace LLMs, agents, vector databases and GPUs with zero-code.
          Visualize application flow, identify performance bottlenecks, and track errors with detailed stack traces.
        </p>
