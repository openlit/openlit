...
import { Database, FolderKanban, Plug } from "lucide-react";
	...
	return (
			<div className="flex h-full w-full flex-col gap-4 overflow-auto p-3 text-stone-700 dark:text-stone-300">
				...
				<TabsList className="h-auto w-full justify-start rounded-md border border-stone-200 bg-white p-1 dark:border-stone-800 dark:bg-stone-950 md:w-auto">
					...
					<TabsTrigger value="sources" className="gap-1.5 text-xs"><Plug className="h-3.5 w-3.5" />{messages.PROJECT_DATA_SOURCES}</TabsTrigger>
				</TabsList>
				...
				<section className="min-h-[520px] overflow-hidden border border-stone-200 bg-white dark:border-stone-800 dark:bg-stone-950">
					...
					<TabsContent value="sources" className="mt-0 data-[state=active]:mt-3">
				<section className="min-h-[520px] overflow-hidden border border-stone-200 bg-white dark:border-stone-800 dark:bg-stone-950">
					<div className="border-b border-stone-200 p-4 dark:border-stone-800">
						<div className="flex items-center gap-2">
					...
					<div className="flex h-[clamp(360px,calc(100dvh-320px),620px)] min-h-0 overflow-hidden">
						<DataSourcesPage projectId={project?.id} />
					</div>
				</section>
				</TabsContent>
			</Tabs>
