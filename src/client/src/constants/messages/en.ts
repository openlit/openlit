...
// Instrumentation Hub
export const INSTRUMENTATION_HUB_FILTER_SYSTEM = "System";
export const INSTRUMENTATION_HUB_FILTER_PROVIDER = "Provider";
export const INSTRUMENTATION_HUB_FILTER_STATUS = "Status";
export const INSTRUMENTATION_HUB_FILTER_STATUS_DISCOVERED = "Discovered";
export const INSTRUMENTATION_HUB_FILTER_STATUS_INSTRUMENTED = "Instrumented";
export const INSTRUMENTATION_HUB_CLEAR_FILTERS = "Clear Filters";
export const INSTRUMENTATION_HUB_APPLY_FILTERS = "Apply Filters";
export const INSTRUMENTATION_HUB_SYSTEM_KUBERNETES = "Kubernetes";
export const INSTRUMENTATION_HUB_SYSTEM_DOCKER = "Docker";
export const INSTRUMENTATION_HUB_SYSTEM_LINUX = "Linux";
export const INSTRUMENTATION_HUB_STAT_CONTROLLERS = "Controllers";
export const INSTRUMENTATION_HUB_STAT_DISCOVERED_SERVICES = "Discovered Services";
export const INSTRUMENTATION_HUB_STAT_INSTRUMENTED_SERVICES = "Instrumented Services";
export const INSTRUMENTATION_HUB_TAB_SERVICES = "Services";
export const INSTRUMENTATION_HUB_TAB_CONTROLLERS = "Controllers";

// Instrumentation Hub - No Controller
export const INSTRUMENTATION_HUB_NO_CONTROLLERS_TITLE = "No controllers detected";
export const INSTRUMENTATION_HUB_NO_CONTROLLERS_DESCRIPTION = "Install the OpenLIT Controller to automatically discover and instrument LLM API calls using eBPF.";
export const INSTRUMENTATION_HUB_API_KEY_PREFILLED_MESSAGE = "Commands below are pre-filled with your API key and dashboard URL. The controller will authenticate automatically.";
export const INSTRUMENTATION_HUB_API_KEY_RECOMMENDED_PREFIX = "Recommended:";
export const INSTRUMENTATION_HUB_API_KEY_RECOMMENDED_BEFORE_LINK = " Create an API key in ";
export const INSTRUMENTATION_HUB_API_KEY_RECOMMENDED_LINK_TEXT = "Settings → API Keys";
export const INSTRUMENTATION_HUB_API_KEY_RECOMMENDED_AFTER_LINK = " to secure your controller connection. Once created, refresh this page to see pre-filled commands.";
export const INSTRUMENTATION_HUB_COPY_TO_CLIPBOARD = "Copy to clipboard";

// Instrumentation Hub - Service Table
export const INSTRUMENTATION_HUB_SERVICE_PID_PREFIX = "PID";
export const INSTRUMENTATION_HUB_SERVICE_ACTION_DISABLING = "Disabling...";
export const INSTRUMENTATION_HUB_SERVICE_ACTION_ENABLING = "Enabling...";
export const INSTRUMENTATION_HUB_SERVICE_ACTION_WORKING = "Working...";
export const INSTRUMENTATION_HUB_SERVICE_ACTION_DISABLE = "Disable";
export const INSTRUMENTATION_HUB_SERVICE_ACTION_ENABLE = "Enable";
export const INSTRUMENTATION_HUB_SERVICE_ACTION_ELLIPSIS = "...";
export const INSTRUMENTATION_HUB_SERVICE_MANUAL_BADGE = "Manual";
export const INSTRUMENTATION_HUB_SERVICE_QUEUED_ACTION = (action: string, serviceName: string) => `Queued ${action} for ${serviceName}`;
export const INSTRUMENTATION_HUB_SERVICE_FAILED = (err: string) => `Failed: ${err}`;
export const INSTRUMENTATION_HUB_AGENT_ENABLING_FOR = (serviceName: string) => `Enabling Agent Observability for ${serviceName}`;
export const INSTRUMENTATION_HUB_AGENT_DISABLING_FOR = (serviceName: string) => `Disabling Agent Observability for ${serviceName}`;
export const INSTRUMENTATION_HUB_COLUMN_SERVICE = "Service";
export const INSTRUMENTATION_HUB_COLUMN_SYSTEM = "System";
export const INSTRUMENTATION_HUB_COLUMN_PROVIDERS = "Providers";
export const INSTRUMENTATION_HUB_COLUMN_LAST_SEEN = "Last Seen";
export const INSTRUMENTATION_HUB_COLUMN_LLM_OBSERVABILITY = "LLM Observability";
export const INSTRUMENTATION_HUB_COLUMN_AGENT_OBSERVABILITY = "Agent Observability";

// Instrumentation Hub - Controller Table
export const INSTRUMENTATION_HUB_COLUMN_CONTROLLER = "Controller";
export const INSTRUMENTATION_HUB_COLUMN_METADATA = "Metadata";
export const INSTRUMENTATION_HUB_COLUMN_SERVICES = "Services";
export const INSTRUMENTATION_HUB_COLUMN_STATUS = "Status";
export const INSTRUMENTATION_HUB_SERVICES_DISCOVERED_COUNT = (discovered: number) => `${discovered} discovered`;
export const INSTRUMENTATION_HUB_SERVICES_INSTRUMENTED_COUNT = (instrumented: number) => ` / ${instrumented} instrumented`;
export const INSTRUMENTATION_HUB_METADATA_NODE_LABEL = "node:";
export const INSTRUMENTATION_HUB_METADATA_NS_LABEL = "ns:";
export const INSTRUMENTATION_HUB_METADATA_POD_LABEL = "pod:";

// Instrumentation Hub - Service Detail
export const INSTRUMENTATION_HUB_SERVICE_DETAIL_DEFAULT_TITLE = "Service Detail";
export const INSTRUMENTATION_HUB_BACK_TO_HUB = "Back to Hub";
export const INSTRUMENTATION_HUB_LOADING_SERVICE_DETAILS = "Loading service details...";
export const INSTRUMENTATION_HUB_STATUS_INSTRUMENTED = "Instrumented";
export const INSTRUMENTATION_HUB_STATUS_DISCOVERED = "Discovered";
export const INSTRUMENTATION_HUB_STAT_PROVIDERS = "Providers";
export const INSTRUMENTATION_HUB_STAT_PID = "PID";
export const INSTRUMENTATION_HUB_STAT_RUNTIME = "Runtime";
export const INSTRUMENTATION_HUB_STAT_FIRST_SEEN = "First Seen";
export const INSTRUMENTATION_HUB_STAT_RUNTIME_UNKNOWN = "Unknown";
export const INSTRUMENTATION_HUB_MODEL_PROVIDERS = "Model Providers";
export const INSTRUMENTATION_HUB_RESOURCE_ATTRIBUTES = "Resource Attributes";
export const INSTRUMENTATION_HUB_CONTROLS = "Controls";
export const INSTRUMENTATION_HUB_LLM_OBSERVABILITY_LABEL = "LLM Observability";
export const INSTRUMENTATION_HUB_LLM_OBSERVABILITY_DESCRIPTION = "Enable eBPF-based observability for LLM and VectorDB traffic — RED metrics, model name, tokens, and tool calls.";
export const INSTRUMENTATION_HUB_AGENT_OBSERVABILITY_LABEL = "Agent Observability";
export const INSTRUMENTATION_HUB_AGENT_OBSERVABILITY_DESCRIPTION = "Injects the OpenLIT agent SDK for LangChain, LangGraph, CrewAI, and similar agent frameworks.";
export const INSTRUMENTATION_HUB_AGENT_ACTION_DOCKER = "Requires container recreate.";
export const INSTRUMENTATION_HUB_AGENT_ACTION_LINUX = "Requires systemd service restart.";
export const INSTRUMENTATION_HUB_AGENT_ACTION_K8S = "Triggers a rolling update.";
export const INSTRUMENTATION_HUB_CURRENTLY_PREFIX = "Currently ";
export const INSTRUMENTATION_HUB_CHECKING_STATUS = "checking status";
export const INSTRUMENTATION_HUB_DEPLOYING_IN_PROGRESS = "deploying (rolling update in progress)";
export const INSTRUMENTATION_HUB_REMOVING_IN_PROGRESS = "removing (rolling update in progress)";
export const INSTRUMENTATION_HUB_ENABLED = "enabled";
export const INSTRUMENTATION_HUB_DISABLED = "disabled";
export const INSTRUMENTATION_HUB_AGENT_USE_NOTE = "Use this only for agent framework spans. Provider-level LLM traffic still comes from eBPF.";
export const INSTRUMENTATION_HUB_SDK_VERSION_LABEL = "SDK version:";
export const INSTRUMENTATION_HUB_MANUAL_SETUP_REQUIRED = "Manual setup required";
export const INSTRUMENTATION_HUB_CONTAINERIZED_WARNING = "This process runs inside a container. Mount the Docker socket or use a Docker/Kubernetes-mode controller for Agent Observability.";
export const INSTRUMENTATION_HUB_NAKED_POD_WARNING = "This is a naked pod (no Deployment, DaemonSet, or StatefulSet). Enabling or disabling Agent Observability will restart the pod.";
export const INSTRUMENTATION_HUB_NAKED_POD_CONFIRM = "This pod has no Deployment or DaemonSet. Enabling Agent Observability will restart the pod. Continue?";
export const INSTRUMENTATION_HUB_AGENT_DEPLOY_QUEUED = "Agent observability is being deployed. The workload will be updated automatically.";
export const INSTRUMENTATION_HUB_AGENT_REMOVE_QUEUED = "Agent observability removal queued. The workload will be updated automatically.";
export const INSTRUMENTATION_HUB_QUEUED_ACTION = (action: string) => `Queued ${action}`;
export const INSTRUMENTATION_HUB_PENDING_INSTRUMENTING = "Instrumenting";
export const INSTRUMENTATION_HUB_PENDING_UNINSTRUMENTING = "Uninstrumenting";
export const INSTRUMENTATION_HUB_PENDING_ENABLING_AGENT = "Enabling Agent Observability";
export const INSTRUMENTATION_HUB_PENDING_DISABLING_AGENT = "Disabling Agent Observability";
export const INSTRUMENTATION_HUB_PENDING_WORKING = "Working";
export const INSTRUMENTATION_HUB_AGENT_TOGGLE_CHECKING = "Checking...";
export const INSTRUMENTATION_HUB_AGENT_TOGGLE_DEPLOYING = "Deploying...";
export const INSTRUMENTATION_HUB_AGENT_TOGGLE_REMOVING = "Removing...";
export const INSTRUMENTATION_HUB_AGENT_TOGGLE_CONFLICT = "Conflict detected";
export const INSTRUMENTATION_HUB_AGENT_TOGGLE_UNAVAILABLE = "Unavailable";
export const INSTRUMENTATION_HUB_AGENT_TOGGLE_DOCKER_NEEDED = "Docker access needed";
export const INSTRUMENTATION_HUB_AGENT_TOGGLE_NOT_MANAGEABLE = "Not manageable";
export const INSTRUMENTATION_HUB_AGENT_TOGGLE_CONTROLLER_UPGRADE = "Controller upgrade needed";
export const INSTRUMENTATION_HUB_ACTION_WORKING_ELLIPSIS = "Working...";
export const INSTRUMENTATION_HUB_ACTION_FAILED = "Action Failed";
export const INSTRUMENTATION_HUB_LAST_ERROR_INSTRUMENT = "Instrument";
export const INSTRUMENTATION_HUB_LAST_ERROR_UNINSTRUMENT = "Uninstrument";
export const INSTRUMENTATION_HUB_LAST_ERROR_ENABLE_AGENT = "Enable Agent Observability";
export const INSTRUMENTATION_HUB_LAST_ERROR_DISABLE_AGENT = "Disable Agent Observability";
export const INSTRUMENTATION_HUB_LAST_ERROR_ACTION = "Action";
export const INSTRUMENTATION_HUB_SERVICE_INFO = "Service Info";
export const INSTRUMENTATION_HUB_OPEN_PORTS = "Open Ports";
export const INSTRUMENTATION_HUB_EXECUTABLE = "Executable";
export const INSTRUMENTATION_HUB_LAST_SEEN_PREFIX = "Last seen ";
export const INSTRUMENTATION_HUB_WORKING_SUFFIX = (label: string) => `${label}...`;

// Instrumentation Hub - Controller Detail
export const INSTRUMENTATION_HUB_CONTROLLER_DEFAULT_TITLE = "Controller";
export const INSTRUMENTATION_HUB_LOADING_CONTROLLER = "Loading controller...";
export const INSTRUMENTATION_HUB_LAST_HEARTBEAT_PREFIX = "Last heartbeat ";
export const INSTRUMENTATION_HUB_STAT_SERVICES_DISCOVERED = "Services Discovered";
export const INSTRUMENTATION_HUB_STAT_INSTRUMENTED = "Instrumented";
export const INSTRUMENTATION_HUB_CONFIG_SAVED = "Configuration saved. Controller will pick it up on next poll.";
export const INSTRUMENTATION_HUB_CONFIG_SAVE_FAILED = (err: string) => `Failed to save config: ${err}`;
export const INSTRUMENTATION_HUB_LOADING_CONFIG = "Loading configuration...";
export const INSTRUMENTATION_HUB_SAVING = "Saving...";
export const INSTRUMENTATION_HUB_SAVE_CONFIGURATION = "Save Configuration";
export const INSTRUMENTATION_HUB_CONFIG_GENERAL = "General";
export const INSTRUMENTATION_HUB_CONFIG_ENVIRONMENT = "Environment";
export const INSTRUMENTATION_HUB_CONFIG_ENVIRONMENT_PLACEHOLDER = "default";
export const INSTRUMENTATION_HUB_CONFIG_ENVIRONMENT_HELP = "Sets deployment.environment on all traces (matches OpenLIT SDK convention)";
export const INSTRUMENTATION_HUB_CONFIG_POLL_INTERVAL = "Poll Interval (seconds)";
export const INSTRUMENTATION_HUB_CONFIG_POLL_INTERVAL_HELP = "How often the controller polls for updates and reports services. Lower values mean faster action response but more load. (5-300s)";
export const INSTRUMENTATION_HUB_CONFIG_EXPORT_SETTINGS = "Export Settings";
export const INSTRUMENTATION_HUB_CONFIG_OTLP_ENDPOINT = "OTLP Endpoint";
export const INSTRUMENTATION_HUB_CONFIG_OTLP_ENDPOINT_PLACEHOLDER = "http://localhost:4318";
export const INSTRUMENTATION_HUB_CONFIG_OTLP_PROTOCOL = "OTLP Protocol";
export const INSTRUMENTATION_HUB_CONFIG_OTLP_PROTOCOL_HTTP = "HTTP/Protobuf";
export const INSTRUMENTATION_HUB_CONFIG_OTLP_PROTOCOL_GRPC = "gRPC";
export const INSTRUMENTATION_HUB_CONFIG_DISCOVERY = "Discovery";
export const INSTRUMENTATION_HUB_CONFIG_AUTO_DISCOVER_LABEL = "Auto-discover LLM services";
export const INSTRUMENTATION_HUB_CONFIG_AUTO_DISCOVER_DESCRIPTION = "Automatically scan for applications making LLM API calls";
export const INSTRUMENTATION_HUB_CONFIG_CUSTOM_LLM_HOSTS = "Custom LLM Hosts";
export const INSTRUMENTATION_HUB_CONFIG_CUSTOM_LLM_HOSTS_HELP = "Add custom hostnames for self-hosted LLM proxies (e.g. LiteLLM, Ollama, Azure per-deployment endpoints). Comma-separated. The controller will resolve these and monitor traffic to them.";
export const INSTRUMENTATION_HUB_CONFIG_CUSTOM_LLM_HOSTS_PLACEHOLDER = "litellm.internal:4000, ollama.internal:11434, my-azure.openai.azure.com";
export const INSTRUMENTATION_HUB_CONFIG_PAYLOAD_EXTRACTION = "Payload Extraction (LLM Providers)";
export const INSTRUMENTATION_HUB_CONFIG_PAYLOAD_EXTRACTION_HELP = "Enable payload extraction to capture GenAI span attributes (prompts, completions, tokens) for each provider.";
export const INSTRUMENTATION_HUB_CONFIG_OTLP_HEADERS = "OTLP Headers";
export const INSTRUMENTATION_HUB_CONFIG_HEADER_NAME_PLACEHOLDER = "Header name";
export const INSTRUMENTATION_HUB_CONFIG_HEADER_VALUE_PLACEHOLDER = "Value";
export const INSTRUMENTATION_HUB_CONFIG_HEADER_REMOVE = "Remove";
export const INSTRUMENTATION_HUB_CONFIG_ADD_HEADER = "+ Add Header";
export const INSTRUMENTATION_HUB_PROVIDER_OPENAI = "OpenAI";
export const INSTRUMENTATION_HUB_PROVIDER_ANTHROPIC = "Anthropic";
export const INSTRUMENTATION_HUB_PROVIDER_GEMINI = "Gemini";
export const INSTRUMENTATION_HUB_PROVIDER_COHERE = "Cohere";
export const INSTRUMENTATION_HUB_PROVIDER_MISTRAL = "Mistral";
export const INSTRUMENTATION_HUB_PROVIDER_GROQ = "Groq";
export const INSTRUMENTATION_HUB_PROVIDER_DEEPSEEK = "DeepSeek";
export const INSTRUMENTATION_HUB_PROVIDER_TOGETHER = "Together AI";
export const INSTRUMENTATION_HUB_PROVIDER_FIREWORKS = "Fireworks AI";
export const INSTRUMENTATION_HUB_PROVIDER_VERCEL_AI = "Vercel AI Gateway";
export const INSTRUMENTATION_HUB_PROVIDER_VERTEX_AI = "Vertex AI";
export const INSTRUMENTATION_HUB_PROVIDER_AZURE_INFERENCE = "Azure AI Inference";
export const INSTRUMENTATION_HUB_PROVIDER_BEDROCK = "AWS Bedrock";
