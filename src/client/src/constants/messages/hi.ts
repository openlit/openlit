...
export const EVALUATION_SAMPLE_RATE_PERCENT_INVALID =
	"सैंपल दर 0 और 100 के बीच एक संख्या होनी चाहिए।";
...
// Agents - Unified detail
export const AGENTS_COLUMN_SOURCE = "स्रोत";
export const AGENTS_SOURCE_CONTROLLER = "कंट्रोलर";
export const AGENTS_SOURCE_SDK = "SDK";
export const AGENTS_SOURCE_BOTH = "कंट्रोलर + SDK";
export const AGENTS_FILTER_STATUS_SDK = "SDK-इंस्ट्रुमेंटेड";
export const AGENTS_SDK_ENABLED_VIA = "सक्षम (SDK के माध्यम से)";
export const AGENTS_SDK_SOURCE_NOTE = "स्रोत: SDK";
export const AGENTS_LOAD_MORE = "और लोड करें";
export const AGENTS_LOAD_MORE_LOADING = "लोड हो रहा है...";
export const AGENTS_TAB_ANALYTICS = "एनालिटिक्स";
export const AGENTS_TAB_CONVERSATIONS = "वार्तालाप";
export const AGENTS_TAB_DEFINITION = "परिभाषा";
export const AGENTS_DEFINITION_SYSTEM_PROMPT = "सिस्टम प्रॉम्प्ट";
export const AGENTS_DEFINITION_TOOLS = "टूल्स";
export const AGENTS_DEFINITION_NO_SYSTEM_PROMPT = "अभी तक कोई सिस्टम प्रॉम्प्ट कैप्चर नहीं हुआ।";
export const AGENTS_DEFINITION_NO_TOOLS = "अभी तक कोई टूल कैप्चर नहीं हुआ।";
export const AGENTS_VERSION_CURRENT = "वर्तमान";
export const AGENTS_VERSION_DRAWER_TITLE = "संस्करण इतिहास";
export const AGENTS_METADATA_PRIMARY_MODEL = "प्राथमिक मॉडल";
export const AGENTS_METADATA_MODELS = "मॉडल";
export const AGENTS_METADATA_TOOLS = "टूल्स";
export const AGENTS_METADATA_AGE = "आयु";
export const AGENTS_METADATA_LAST_SEEN = "अंतिम बार देखा गया";
export const AGENTS_METADATA_REQUESTS_24H = "अनुरोध (24 घंटे)";
export const AGENTS_REFRESH = "ताज़ा करें";
export const AGENTS_REFRESHING = "ताज़ा कर रहे हैं...";
