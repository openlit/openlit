...
import (
	...
	"github.com/openlit/openlit/openlit-collector/internal/engine"
	"github.com/openlit/openlit/openlit-collector/internal/openlit"
	"github.com/openlit/openlit/openlit-collector/internal/server"
	"go.uber.org/zap"
)
...
func main() {
	...
	logger.Info("openlit-collector starting",
	...
	var mode openlit.CollectorMode
