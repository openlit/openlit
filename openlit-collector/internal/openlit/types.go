...
const (
	ModeLinux      CollectorMode = "linux"
	ModeDocker     CollectorMode = "docker"
	ModeKubernetes CollectorMode = "kubernetes"
)

// PollRequest is sent by the collector to OpenLIT on each poll cycle.
