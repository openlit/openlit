...
def test_http_requests():
    ...
    logger.info("🌐 Testing HTTP requests...")
    
    try:
        # Test basic HTTP GET
        response = requests.get('https://httpbin.org/get', timeout=10)
        logger.info(f"✅ HTTP GET successful: {response.status_code}")
        ...
        logger.info(f"✅ HTTP POST successful: {response.status_code}")
        ...
        logger.info(f"✅ HTTP with headers successful: {response.status_code}")
...
def test_openai_calls():
    ...
    try:
        ...
        logger.info("🔄 Making OpenAI chat completion request...")
        ...
        logger.info(f"✅ OpenAI Chat Completion successful!")
        logger.info(f"📝 Response: {response_content}")
        
        # Test completion (legacy)
        logger.info("🔄 Making OpenAI completion request...")
        ...
        logger.info(f"✅ OpenAI Completion successful!")
...
def display_environment_info():
    ...
    if '/openlit-sdk' in pythonpath:
        logger.info("✅ OpenLIT SDK path detected in PYTHONPATH")
    else:
        logger.warning("⚠️  OpenLIT SDK path not found in PYTHONPATH")

def main():
    """Main application loop"""
    logger.info("🚀 Starting OpenLIT Test Application")
    ...
    while True:
        ...
        logger.info(f"⏰ Waiting 30 seconds before next test iteration...")
        time.sleep(30)
        test_count += 1
