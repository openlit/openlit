...
os.environ["OPENAI_API_KEY"] = (
    "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"
)
...
def debug_mem0_instrumentation():
    ...
    try:
        openlit.init(detailed_tracing=True, otlp_endpoint="http://127.0.0.1:4318")
    ...
    try:
        ...
        result = memory.add("Debug test for span hierarchy", user_id="debug_user")
        ...
        if mem0_spans:
            ...
            for span in mem0_spans:
                parent_status = (
                    ...
                    else f"CHILD of {span['parent_id'][:8]}..."
                )
