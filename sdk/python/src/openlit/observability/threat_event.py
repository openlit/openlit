"""
Helpers for emitting OpenTelemetry-native agent threat detection events.
"""
...
def record_threat_detected(
    ...
    **attributes,
    ...
    event_attributes = {
        SemanticConvention.GEN_AI_AGENT_THREAT_RULE_ID: rule_id,
        SemanticConvention.GEN_AI_AGENT_THREAT_SEVERITY: severity,
        SemanticConvention.GEN_AI_AGENT_THREAT_CLASS: threat_class,
    }
