...
"""
Module for monitoring Elasticsearch operations.
"""
...
def general_wrap(
    ...
    """
    Generates a telemetry wrapper for Elasticsearch function calls.
    """
    # pylint: disable=too-many-arguments, too-many-positional-arguments

    def wrapper(wrapped, instance, args, kwargs):
        """
        Wraps an Elasticsearch operation with tracing and metrics.
        """
