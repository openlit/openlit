...
class LlamaIndexInstrumentor(BaseInstrumentor):
    ...
    def _instrument(self, **kwargs):
        ...
        async_operations = [
            ...
            ("llama_index.core.indices.vector_store.retrievers.retriever", "VectorIndexRetriever.aretrieve", "retriever_retrieve_async"),
        ...
        component_operations = [
            ...
            ("llama_index.core.indices.vector_store.retrievers.retriever", "VectorIndexRetriever._get_nodes_with_embeddings", "retrieval_get_nodes"),
            ("llama_index.core.indices.vector_store.retrievers.retriever", "VectorIndexRetriever._build_node_list_from_query_result", "retrieval_build_nodes"),
            ("llama_index.core.postprocessor.node", "BaseNodePostprocessor.postprocess_nodes", "postprocessor_process"),

            # Response Generation Components
            ("llama_index.core.response_synthesizers.base", "BaseSynthesizer.synthesize", "response_synthesize"),
            ("llama_index.core.response_synthesizers.compact_and_refine", "CompactAndRefine.synthesize", "response_compact_refine"),
            ("llama_index.core.response_synthesizers.tree_summarize", "TreeSummarize.synthesize", "response_tree_summarize"),
            ...
            ("llama_index.core.query_engine.retriever_query_engine", "RetrieverQueryEngine._prepare_response_builder", "query_prepare_response"),
        ]
        ...
        for module, method, operation_type in async_operations:
            try:
                wrap_function_wrapper(module, method, async_general_wrap(operation_type, version, environment, application_name, tracer, pricing_info, capture_message_content, metrics, disable_metrics))
            except Exception:
                pass
