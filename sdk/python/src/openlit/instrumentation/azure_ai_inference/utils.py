...
def common_chat_logic(
    ...
    # Azure AI Inference prompt_tokens are inclusive of cached tokens.
    ...
    version_extras = apply_agent_version_attributes(
        ...
        runtime_config={
            ...
            "provider": SemanticConvention.GEN_AI_SYSTEM_AZURE_AI_INFERENCE,
        },
        providers=[SemanticConvention.GEN_AI_SYSTEM_AZURE_AI_INFERENCE],
    )
