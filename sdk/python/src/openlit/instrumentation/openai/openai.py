...
def create_telemetry_attributes(
    service_name: str,
            ...
            try:
                ...
                try:
                    ...
                    self._span.set_attribute(SemanticConvetion.GEN_AI_USAGE_COST,
                                        cost)
                    self._span.set_attribute(SemanticConvetion.GEN_AI_CLIENT_OPERATION_DURATION,
                    ...
                    if disable_metrics is False:
                        attributes = create_telemetry_attributes(
            ...
            with tracer.start_as_current_span(gen_ai_endpoint, kind= SpanKind.CLIENT) as span:
                ...
                try:
                    ...
                    span.set_attribute(SemanticConvetion.GEN_AI_USAGE_COST,
                                        cost)
                    span.set_attribute(SemanticConvetion.GEN_AI_CLIENT_OPERATION_DURATION,
                                        end_time - start_time)
        ...
        with tracer.start_as_current_span(gen_ai_endpoint, kind= SpanKind.CLIENT) as span:
            ...
            try:
                ...
                cost = get_embed_model_cost(kwargs.get("model", "text-embedding-ada-002"),
                                    pricing_info, response_dict.get('usage').get('input_tokens'))
                ...
                span.set_attribute(SemanticConvetion.GEN_AI_REQUEST_USER,
                                    kwargs.get("user", ""))
                span.set_attribute(SemanticConvetion.GEN_AI_USAGE_INPUT_TOKENS,
                                    response_dict.get('usage').get('input_tokens'))
                span.set_attribute(SemanticConvetion.GEN_AI_USAGE_TOTAL_TOKENS,
                ...
                if disable_metrics is False:
                    ...
                    metrics["genai_input_tokens"].add(
                        response_dict.get('usage').get('input_tokens'), attributes)
                    metrics["genai_cost"].record(cost, attributes)
        ...
        with tracer.start_as_current_span(gen_ai_endpoint, kind= SpanKind.CLIENT) as span:
            ...
            try:
                ...
                span.set_attribute(SemanticConvetion.GEN_AI_SYSTEM,
                                    SemanticConvetion.GEN_AI_SYSTEM_OPENAI)
                span.set_attribute(SemanticConvetion.GEN_AI_OPERATION,
                                    SemanticConvetion.GEN_AI_OPERATION_TYPE_FINETUNING)
                span.set_attribute(SemanticConvetion.GEN_AI_ENDPOINT,
                                    gen_ai_endpoint)
                span.set_attribute(SemanticConvetion.GEN_AI_ENVIRONMENT,
                                    environment)
