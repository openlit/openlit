...
describe('PII Guard', () => {
    const guard = new pii_1.PII({ action: 'redact' });
    const denyGuard = new pii_1.PII({ action: 'deny' });
    const warnGuard = new pii_1.PII({ action: 'warn' });
    ...
    it('supports custom patterns', () => {
        const custom = new pii_1.PII({ action: 'redact', customPatterns: { 'my-token': 'MYTOKEN_[A-Z]{10}' } });
