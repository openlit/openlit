...
function spanCreationAttrs(operationName, requestModel) {
    return {
        ...
        [semantic_convention_1.default.GEN_AI_PROVIDER_NAME_OTEL]: GroqWrapper.aiSystem,
        [semantic_convention_1.default.GEN_AI_REQUEST_MODEL]: requestModel,
        [semantic_convention_1.default.SERVER_ADDRESS]: GroqWrapper.serverAddress,
        [semantic_convention_1.default.SERVER_PORT]: GroqWrapper.serverPort,
    };
}
class GroqWrapper extends base_wrapper_1.default {
        ...
        return (originalMethod) => {
            return async function (...args) {
                ...
                return api_1.context
                    ...
                    if (stream) {
                        return helpers_1.default.createStreamProxy(response, GroqWrapper._chatCompletionGenerator({
                            args,
                            genAIEndpoint,
                            response,
                            span,
        ...
        try {
            const versionHash = helpers_1.default.computeAgentVersionHash({
                ...
                runtimeConfig: {
                    ...
                    provider: semantic_convention_1.default.GEN_AI_SYSTEM_GROQ,
                },
                providers: [semantic_convention_1.default.GEN_AI_SYSTEM_GROQ],
            });
            if (versionHash) {
...
GroqWrapper.aiSystem = semantic_convention_1.default.GEN_AI_SYSTEM_GROQ;
GroqWrapper.serverAddress = 'api.groq.com';
GroqWrapper.serverPort = 443;
exports.default = GroqWrapper;
