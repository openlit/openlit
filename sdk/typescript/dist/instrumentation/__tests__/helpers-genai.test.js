...
describe('OpenLitHelper.buildSystemInstructionsFromMessages', () => {
    it('returns undefined for empty or missing input', () => {
        expect(helpers_1.default.buildSystemInstructionsFromMessages([])).toBeUndefined();
        expect(helpers_1.default.buildSystemInstructionsFromMessages(null)).toBeUndefined();
        expect(helpers_1.default.buildSystemInstructionsFromMessages(undefined)).toBeUndefined();
    });
    it('returns undefined when no system role is present', () => {
        ...
        expect(helpers_1.default.buildSystemInstructionsFromMessages(messages)).toBeUndefined();
    });
    it('extracts a single system message with string content', () => {
        ...
        const raw = helpers_1.default.buildSystemInstructionsFromMessages(messages);
...
describe('OpenLitHelper.buildToolDefinitions', () => {
    it('returns undefined for empty or missing input', () => {
        expect(helpers_1.default.buildToolDefinitions(undefined)).toBeUndefined();
        expect(helpers_1.default.buildToolDefinitions(null)).toBeUndefined();
        expect(helpers_1.default.buildToolDefinitions([])).toBeUndefined();
    });
    it('extracts an OpenAI-style function schema', () => {
        ...
        const raw = helpers_1.default.buildToolDefinitions(tools);
        expect(JSON.parse(raw)).toEqual([
            {
                type: 'function',
                name: 'get_weather',
    ...
    it('returns undefined when every entry is unusable', () => {
        ...
        expect(helpers_1.default.buildToolDefinitions(tools)).toBeUndefined();
    });
    it('returns undefined when input is not an array', () => {
        ...
        expect(helpers_1.default.buildToolDefinitions({ name: 'not-an-array' })).toBeUndefined();
    });
});
describe('OpenLitHelper.computeAgentVersionHash', () => {
    ...
    function hash(overrides = {}) {
        return helpers_1.default.computeAgentVersionHash({
    ...
    it('changes when temperature changes', () => {
        expect(hash()).not.toBe(hash({ runtimeConfig: { ...BASE_RUNTIME, temperature: 0.9 } }));
    });
    ...
    it('produces the same digest as the Python SDK for the same inputs', () => {
        ...
        const h = helpers_1.default.computeAgentVersionHash({
...
//# sourceMappingURL=helpers-genai.test.js.map