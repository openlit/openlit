...
<Steps>
  ...
  <Step title="Generate an API Key">
    With Doku running, the next step is to [generate an API key](/0.0.6/api-reference/endpoint/api-keys/create) for secure communication between your applications and Doku.
