...
- [Chat](/0.0.6/integrations/cohere/examples/chat)
- [Generate](/0.0.6/integrations/cohere/examples/generate)
- [Summarize](/0.0.6/integrations/cohere/examples/summarize)
- [Embed](/0.0.6/integrations/cohere/examples/embed)
