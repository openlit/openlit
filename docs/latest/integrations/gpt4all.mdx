---
title: 'Monitor GPT4All using OpenTelemetry'
sidebarTitle: 'GPT4All'
---

<Frame>
  <img src="/images/docs-gpt4all-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using models from GPT4All. This includes tracking performance, token usage, and how users interact with the application.
...
- GPT4All Python SDK client `>=2.6.0` 
