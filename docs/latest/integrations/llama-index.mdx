...
OpenLIT SDKs provide OpenTelemetry Auto-Instrumentation for monitoring LLM Application using LlamaIndex which includes performance and operation stats.
