...
- [Chat completions](/latest/integrations/azure-openai/examples/chat)
- [Image Create](/latest/integrations/azure-openai/examples/image#create-image)
- [Embeddings](/latest/integrations/azure-openai/examples/embeddings)
- [Completions](/latest/integrations/azure-openai/examples/completions)
