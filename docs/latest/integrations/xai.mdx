---
title: 'Monitor xAI using OpenTelemetry'
sidebarTitle: 'xAI'
---

<Frame>
  <img src="/images/docs-xai-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using xAI models. This includes tracking performance, token usage, costs, and how users interact with the application.
