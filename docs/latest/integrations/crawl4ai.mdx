---
title: 'Monitor Crawl4AI using OpenTelemetry'
sidebarTitle: 'Crawl4AI'
---

<Frame>
  <img src="/images/docs-crawl4ai-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor Crawling Agents built using Crawl4AI. This includes tracking performance and operation stats.
...
- Crawl4AI Python SDK client `>= 0.4.0` 
