---
title: 'Monitor AI21 using OpenTelemetry'
sidebarTitle: 'AI21'
---

<Frame>
  <img src="/images/docs-ai21-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using AI21 models. This includes tracking performance, token usage, costs, and how users interact with the application.
