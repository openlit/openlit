---
title: 'Monitor AutoGen using OpenTelemetry'
sidebarTitle: 'AutoGen / AG2'
---

<Frame>
  <img src="/images/docs-ag2-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI Agents built using AutoGen. This includes tracking performance and operation stats.
...
- AG2 / AutoGen Python SDK client `>= 0.3.2` 
