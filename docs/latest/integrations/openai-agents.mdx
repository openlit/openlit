...
OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI Agents built using OpenAI Agents SDK. This includes tracking performance and operation stats.
...
- OpenAI Agents Python SDK client `>= 0.0.3` 
