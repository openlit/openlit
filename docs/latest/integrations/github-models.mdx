---
title: 'Monitor GitHub Models using OpenTelemetry'
sidebarTitle: 'GitHub Models'
---

<Frame>
  <img src="/images/docs-github-models-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using GitHub AI Models. This includes tracking performance, token usage, costs, and how users interact with the application.
