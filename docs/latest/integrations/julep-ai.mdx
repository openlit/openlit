---
title: 'Monitor Julep AI using OpenTelemetry'
sidebarTitle: 'Julep AI'
---

<Frame>
  <img src="/images/docs-julep-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI Agents built using Julep AI. This includes tracking performance and operation stats.
...
- Julep AI Python SDK client `>= 1.42.0` 
