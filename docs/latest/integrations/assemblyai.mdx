---
title: 'Monitor Assembly AI using OpenTelemetry'
sidebarTitle: 'Assembly AI'
---

<Frame>
  <img src="/images/docs-assemblyai-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using Audio and Speech models from Assembly AI. This includes tracking performance, costs, Voice inputs and settings and how users interact with the application.
...
- Assembly AI Python SDK client `>= 0.35.1` 
...
<Steps>
    ...
    To send metrics and traces to other Observability tools, refer to the [Connections Guide](/latest/destinations/intro).
