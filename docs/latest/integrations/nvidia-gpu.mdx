...
<Frame>
  <img src="/images/docs-nvidia-gpu-banner.gif" />
</Frame>
...
Auto-instrumentation means you don't have to set up monitoring manually. By simply adding the OpenLIT in your application, all the necessary monitoring configurations are automatically set up for you.

## Get Started 

<Steps>
    <Step title="Install OpenLIT and gpustat library">
      Open your command line or terminal and run:
      ```shell
      pip install openlit gpustat==1.1.1
      ```
    </Step>
