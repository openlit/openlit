...
OpenLIT uses OpenTelemetry to help you monitor NVIDIA GPUs. This includes tracking performance, token usage, costs, and how users interact with the application.
