...
Auto-instrumentation means you don't have to set up monitoring manually. By simply adding OpenLIT in your application, all the necessary monitoring configurations are automatically set up for you.
