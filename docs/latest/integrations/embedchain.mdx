---
title: 'Monitor EmbedChain using OpenTelemetry'
sidebarTitle: 'EmbedChain'
---

<Frame>
  <img src="/images/docs-embedchain-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using EmbedChain. This includes tracking performance and operation stats.
...
- EmbedChain Python SDK client `>= 0.1.104` 
