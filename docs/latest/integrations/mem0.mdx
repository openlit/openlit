---
title: 'Monitor mem0 using OpenTelemetry'
sidebarTitle: 'mem0'
---

<Frame>
  <img src="/images/docs-mem0-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using mem0. This includes tracking performance and operation stats.
