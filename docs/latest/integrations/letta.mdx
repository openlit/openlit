---
title: 'Monitor Letta using OpenTelemetry'
sidebarTitle: 'Letta'
---

<Frame>
  <img src="/images/docs-letta-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI Agents built using Letta. This includes tracking performance and operation stats.
