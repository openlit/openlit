---
title: 'Monitor Titan ML using OpenTelemetry'
sidebarTitle: 'Titan ML'
---

<Frame>
  <img src="/images/docs-titan-ml-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using Titan ML models. This includes tracking performance, token usage, costs, and how users interact with the application.
...
<Steps>
    ...
    <Tabs>
      ...
      <Tabs>
        ...
        <Tab title="Typescript">
        <Warning>Typescript sdk for openai doesn't support metrics tracking for now!</Warning>
