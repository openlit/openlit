---
title: 'Monitor Together using OpenTelemetry'
sidebarTitle: 'Together'
---

<Frame>
  <img src="/images/docs-together-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using Together models. This includes tracking performance, token usage, costs, and how users interact with the application.
...
- Together Python SDK client `>=1.3.5` 
