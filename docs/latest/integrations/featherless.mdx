---
title: 'Monitor Featherless using OpenTelemetry'
sidebarTitle: 'Featherless'
---

<Frame>
  <img src="/images/docs-featherless-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using Featherless models. This includes tracking performance, token usage, costs, and how users interact with the application.
...
As Featherless uses the OpenAI SDK, This integration is compatible with  
