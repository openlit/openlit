...
<Frame>
  <img src="/images/docs-vllm-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using models from vLLM. This includes tracking performance, token usage, and how users interact with the application.
