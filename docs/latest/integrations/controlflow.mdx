---
title: 'Monitor ControlFlow using OpenTelemetry'
sidebarTitle: 'ControlFlow'
---

<Frame>
  <img src="/images/docs-controlflow-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI Agents built using ControlFlow. This includes tracking performance and operation stats.
...
- ControlFlow Python SDK client `>= 0.11.3` 
