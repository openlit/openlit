...
OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications using Qdrant as the vector store. This includes tracking performance, operation stats and more.
