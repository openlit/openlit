---
title: 'Monitor Dynamiq using OpenTelemetry'
sidebarTitle: 'Dynamiq'
---

<Frame>
  <img src="/images/docs-dynamiq-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI Agents built using Dynamiq. This includes tracking performance and operation stats.
