---
title: 'Monitor NVIDIA NIM using OpenTelemetry'
sidebarTitle: 'NVIDIA NIM'
---
...
OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using NVIDIA NIM models. This includes tracking performance, token usage, costs, and how users interact with the application.
