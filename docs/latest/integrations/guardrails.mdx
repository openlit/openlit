---
title: 'Monitor Guardrails AI using OpenTelemetry'
sidebarTitle: 'Guardrails AI'
---

<Frame>
  <img src="/images/docs-guardrails-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using Guardrails. This includes tracking performance and operation stats.
