---
title: 'Monitor FireCrawl using OpenTelemetry'
sidebarTitle: 'FireCrawl'
---

<Frame>
  <img src="/images/docs-firecrawl-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor crawling Agents built using FireCrawl. This includes tracking performance and operation stats.
...
- FireCrawl Python SDK client `>= 1.6.3` 
