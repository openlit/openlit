---
title: 'Monitor CrewAI using OpenTelemetry'
sidebarTitle: 'CrewAI'
---

<Frame>
  <img src="/images/docs-crewai-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI Agents built using CrewAI. This includes tracking performance and operation stats.
