---
title: 'Monitor AstraDB using OpenTelemetry'
sidebarTitle: 'AstraDB'
---

<Frame>
  <img src="/images/docs-astradb-banner.gif" />
</Frame>

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications using AstraDB as the vector store. This includes tracking performance, operation stats and more.
...
- AstraDB Python SDK client `>= 1.5.2` 
