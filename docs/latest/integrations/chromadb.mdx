...
OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications using ChromaDB as the vector store. This includes tracking performance, operation stats and more.
...
- ChromaDB Python SDK client `>= 0.4.0` 
