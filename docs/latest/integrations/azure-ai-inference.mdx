---
title: 'Monitor Azure AI Inference using OpenTelemetry'
sidebarTitle: 'Azure AI Inference'
---
...
OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using Azure Azure AI Inference models. This includes tracking performance, token usage, costs, and how users interact with the application.
...
- azure-ai-inference Python SDK client `>=1.0.0b4` 
