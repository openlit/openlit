...
OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using Mistral models. This includes tracking performance, token usage, costs, and how users interact with the application.
...
- Mistral Python SDK client `>= 1.0.0` 
