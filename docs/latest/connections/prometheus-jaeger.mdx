...
To send OpenTelemetry metrics and traces collected by OpenLIT from your LLM Application to Prometheus and Jaeger, Add the snippet below to your Python application.
...
<Steps>
  ...
  <Step title="Configure the OpenTelemetry Collector">
    ...
    2. **Define Exporters**: Add `prometheusremotewrite` and `otlp` exporters.
        ...
        1. `YOUR_JAEGER_URL` with the URL of Jaeger 
            * Example - `jaeger:4317`
  ...
  1. Make sure Prometheus and Jaeger are added as a datasource in Grafana. To add a new datasource, You can follow the steps in the [Official documentation](https://grafana.com/docs/grafana/latest/datasources/#add-a-data-source)
  1. Once Prometheus and Jaeger are available as data source in Grafana, Click **Dashboards** in the primary menu.
      ...
      ```json
      {
        ...
        "panels": [
            ...
            "targets": [
                ...
                "service": "$application",
                "tableType": "traces",
                "tags": "otel.status_code=\"OK\" telemetry.sdk.name=\"openlit\""
                }
            ],
            ...
            "targets": [
                ...
                "disableTextWrap": false,
                "editorMode": "code",
                "expr": "avg(gen_ai_usage_prompt_tokens{telemetry_sdk_name=\"openlit\", gen_ai_application_name=~\"$application\", gen_ai_environment=~\"$environment\"})",
                "fullMetaSearch": false,
                "includeNullMetadata": true,
                "instant": false,
            ...
            "targets": [
                ...
                "service": "$application",
                "tableType": "traces",
                "tags": "otel.status_code=\"OK\" gen_ai.type=\"chat\""
                }
            ],
            "transparent": true,
            "type": "table"
            ...
            "targets": [
                ...
                "service": "$application",
                "tableType": "traces",
                "tags": "gen_ai.type=\"vectordb\" otel.status_code=\"OK\""
                }
            ],
            "transparent": true,
            "type": "table"
