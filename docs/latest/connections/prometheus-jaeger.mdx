...
To send OpenTelemetry metrics and traces collected by OpenLIT from your LLM Application to Prometheus and Jaeger, Follow the below step.
      ...
      ```json
      {
        ...
        "panels": [
            ...
            "targets": [
                ...
                "service": "$application",
                "tableType": "traces",
                "tags": "otel.status_code=\"OK\" gen_ai.operation.name=\"chat\""
                }
            ],
            "transparent": true,
            "type": "table"
            ...
            "targets": [
                ...
                "service": "$application",
                "tableType": "traces",
                "tags": "gen_ai.operation.name=\"vectordb\" otel.status_code=\"OK\""
                }
            ],
            "transparent": true,
            "type": "table"
