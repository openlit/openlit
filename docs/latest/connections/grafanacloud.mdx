---
title: 'Grafana Cloud'
description: 'LLM Observability with Grafana Cloud and Doku'
---
...
Make the following curl request to Doku to add a connection for Grafana Cloud. See more on the [Connections API](/latest/api-reference/endpoint/connections/create)
