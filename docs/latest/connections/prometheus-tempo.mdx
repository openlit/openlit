...
To send OpenTelemetry metrics and traces collected by OpenLIT from your LLM Application to Prometheus and Grafana tempo, Add the snippet below to your Python application.
