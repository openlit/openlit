...
Make the following curl request to Doku to add a connection for DataDog. See more on the [Connections API](/latest/api-reference/endpoint/connections/create)
