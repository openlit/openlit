            ...
            "widgets": [
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT sum(`gen_ai.total.requests`) AS 'GenAI Requests by Type' FROM Metric FACET `gen_ai.operation.name` WHERE `telemetry.sdk.name` = 'openlit' LIMIT 5"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT timestamp, trace.id, gen_ai.operation.name AS 'Category', gen_ai.environment AS 'Environment', gen_ai.application_name AS 'Application', gen_ai.request.model AS 'Model', gen_ai.prompt AS 'Prompt', \ngen_ai.content.completion AS 'Completion', gen_ai.usage.cost AS 'Usage Cost', duration.ms AS 'Duration' FROM Span WHERE gen_ai.operation.name != 'vectordb' And gen_ai.operation.name != 'framework'"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
