...
<Steps>
  <Step title="Get your New Relic Crednetials">
    <Steps>
            ...
            "widgets": [
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT average(`gen_ai.usage.cost`) AS 'Average Usage Cost' FROM Metric WHERE `telemetry.sdk.name` = 'openlit'"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT sum(`gen_ai.usage.cost`) AS 'Total Usage Cost' FROM Metric WHERE `telemetry.sdk.name` = 'openlit'"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT sum(`gen_ai.usage.total_tokens`) AS 'Total Tokens' FROM Metric WHERE `telemetry.sdk.name` = 'openlit'"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT sum(`gen_ai.total.requests`) AS 'GenAI Requests by Platform' FROM Metric FACET `gen_ai.system` WHERE `telemetry.sdk.name` = 'openlit' LIMIT 5"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT sum(`gen_ai.total.requests`) AS 'GenAI Requests by Type' FROM Metric FACET `gen_ai.type` WHERE `telemetry.sdk.name` = 'openlit' LIMIT 5"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT sum(`gen_ai.total.requests`) AS 'GenAI Requests by Environment' FROM Metric FACET `gen_ai.environment` WHERE `telemetry.sdk.name` = 'openlit' LIMIT 5"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT sum(`gen_ai.total.requests`) AS 'GenAI Requests by Application' FROM Metric FACET `gen_ai.application_name` WHERE `telemetry.sdk.name` = 'openlit' LIMIT 5"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT average(`gen_ai.usage.prompt_tokens`) AS 'Avg Prompt Tokens', average(`gen_ai.usage.completion_tokens`) AS 'Avg Completion Tokens', average(`gen_ai.usage.cost`) AS 'Avg Usage Cost' FROM Metric WHERE `telemetry.sdk.name` = 'openlit' TIMESERIES "
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT timestamp, trace.id, gen_ai.type AS 'Category', gen_ai.environment AS 'Environment', gen_ai.application_name AS 'Application', gen_ai.request.model AS 'Model', gen_ai.content.prompt AS 'Prompt', \ngen_ai.content.completion AS 'Completion', gen_ai.usage.cost AS 'Usage Cost', duration.ms AS 'Duration' FROM Span WHERE gen_ai.type != 'vectordb' And gen_ai.type != 'framework'"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
                ...
                "rawConfiguration": {
                    ...
                    "nrqlQueries": [
                    {
                        ...
                        "query": "SELECT timestamp, trace.id, gen_ai.environment AS 'Environment', gen_ai.application_name AS 'Application', db.system AS 'System', db.operation AS 'Operation', duration.ms AS 'Duration' FROM Span SINCE 24 hours ago WHERE gen_ai.type = 'vectordb'"
                    }
                    ],
                    "platformOptions": {
                    "ignoreTimeRange": false
