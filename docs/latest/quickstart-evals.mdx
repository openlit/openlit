...
<Steps>
    ...
    For details on how it works, and to see the supported providers, models and parameters to pass, check our [Evaluations Guide](/latest/sdk/features/evaluations).
    </Step>
    <Step title="Collecting Evaluation metrics">
        ...
        These metrics can be sent to any OpenTelemetry-compatible backend. For configuration details, check out our [Connections Guide](/latest/sdk/destinations/intro) to choose your preferred destination for these metrics.
    </Step>
