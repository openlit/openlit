---
title: "Overview"
description: "OpenLIT ships first-class observability for AI coding agents - Claude Code, Cursor, Codex, OpenCode, and Windsurf - with no SDK and no code changes"
---
...
<CardGroup cols={2}>
  <Card title="Setup & Configure" href="/latest/openlit/coding-agents/setup-and-configure" icon='download'>
    Install the CLI, wire Claude Code, Cursor, Codex, or OpenCode, and stop tracking when you need to
  </Card>
