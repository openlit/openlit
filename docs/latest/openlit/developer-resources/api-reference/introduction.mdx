...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/latest/openlit/developer-resources/api-reference/endpoint/scanners/scan"
  >
  </Card>
</CardGroup>
...
- **Scanner** — `POST /api/scanners/{id}/scan`, `GET /api/scanners`, and `GET /api/scanners/findings` for Trustabl jobs and findings

See [AI Analysis](/latest/openlit/observability/telemetry/ai-analysis), [Chat with Otter](/latest/openlit/chat/overview), and [Scanner connectors](/latest/openlit/connectors/scanner) for product docs.
...
### Non-SDK APIs (telemetry, Ask Otter, AI Analysis, Scanner, …)
