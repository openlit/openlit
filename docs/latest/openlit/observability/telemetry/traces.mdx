...
<Frame>
  <img src="/images/traces-generation-issues.png" alt="Generation issues chips on the Traces page: Truncated, Filtered, Empty, and Model swapped" />
</Frame>
...
<Frame>
  <img src="/images/traces-generation-issues-tooltip.png" alt="Tooltip on the Truncated chip explaining token-limit stops and that clicking filters the list" />
</Frame>
...
<Frame>
  <img src="/images/traces-generation-issues-filtered.png" alt="Traces list filtered to Truncated generations, with Truncated badges on openai.chat.completions rows" />
</Frame>
...
<Frame>
  <img src="/images/traces-generation-issue-detail.png" alt="Trace detail warning that generation stopped because the model hit max tokens" />
</Frame>
