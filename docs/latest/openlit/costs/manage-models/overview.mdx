...
Out of the box you get: OpenAI, Anthropic, Google AI, Mistral AI, Groq, Perplexity, Azure OpenAI, Cohere, Together AI, Fireworks AI, DeepSeek, xAI, Hugging Face, Replicate, MiniMax, and OrcaRouter. **TypeSafe** is also seeded for Jev evaluation models (`jev-latest`, `jev-1.13.0`, `jev-preview`) at $0.042 per million input tokens and $0 output. Jev is an evaluation provider, not a Chat or OpenGround model. Model lists change as the catalog is updated. Treat Manage models itself as the source of truth for what is installed in your database.
