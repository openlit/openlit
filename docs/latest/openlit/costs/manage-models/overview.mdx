...
Out of the box you get: OpenAI, Anthropic, Google AI, Mistral AI, Groq, OrcaRouter, Perplexity, Azure OpenAI, Cohere, Together AI, Fireworks AI, DeepSeek, xAI, Hugging Face, and Replicate. Model lists change as the catalog is updated - treat Manage models itself as the source of truth for what is installed in your database.
