...
Providers are the top-level grouping for models on **Manage Models** (`/costs?tab=models`). OpenLIT ships 16 built-in chat providers plus **TypeSafe** for Jev evaluation models; you can add your own for self-hosted or niche APIs.
