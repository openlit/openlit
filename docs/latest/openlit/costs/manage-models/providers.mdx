...
Providers are the top-level grouping for models on **Manage Models** (`/costs?tab=models`). OpenLIT ships 15 built-in providers; you can add your own for self-hosted or niche APIs.
