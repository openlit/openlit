...
<AccordionGroup>
  ...
  <Accordion title="How many providers are supported out of the box?">
    15: OpenAI, Anthropic, Google, Mistral, Groq, OrcaRouter, Perplexity, Azure, Cohere, Together AI, Fireworks, DeepSeek, xAI, Hugging Face, and Replicate. See [Run a Comparison](/latest/openlit/prompts-experiments/openground/run-a-comparison) for how to configure one.
  </Accordion>
