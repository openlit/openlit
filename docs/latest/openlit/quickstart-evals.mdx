  ...
  <Tab title="Online">
    ...
    <Steps>
      <Step title="Pick a judge model">
        Go to **Evaluations → Settings**, choose a provider and model to act as the judge (OpenAI, Anthropic, Google, Mistral, TypeSafe Jev, and others), and add its API key from [Vault](/latest/openlit/developer-resources/vault/overview). TypeSafe Jev uses the System One API rather than chat completions. See [TypeSafe Jev judge](/latest/openlit/evaluations/evaluators#typesafe-jev-judge).
      </Step>
