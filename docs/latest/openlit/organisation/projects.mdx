...
| **Connectors** | Data-source (Tempo, Loki, Prometheus, Jaeger, ClickHouse), memory (Claude, Letta, Mem0, Zep), and scanner (Trustabl) |
...
<CardGroup cols={2}>
  ...
  <Card title="Connectors" href="/latest/openlit/connectors/overview" icon="plug">
    Data-source, memory, and scanner connectors on the project.
  </Card>
