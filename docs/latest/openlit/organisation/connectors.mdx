...
<Frame>
  <img src="/images/organisation/connectors-list.png" alt="OpenLIT connectors list for the current project" />
</Frame>
...
<Frame>
  <img src="/images/organisation/connectors-list.png" alt="OpenLIT connectors page for the active project" />
</Frame>

1. Select a [project](/latest/openlit/organisation/projects) and environment in the header.  
2. Open **Connectors** and browse the catalog for **Jaeger**.  
3. Set the Query URL (local all-in-one: `http://localhost:16686`) and auth if needed.  
4. Bind **traces** to the connector under [signal routing](/latest/openlit/organisation/signal-routing).  
