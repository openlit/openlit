...
Organisations in OpenLIT are shared workspaces for teams. Inside an organisation, **projects** own everything you configure for telemetry backends: environments, Database Configs, connectors, and signal bindings.
...
<CardGroup cols={2}>
  ...
  <Card title="Connectors" href="/latest/openlit/organisation/connectors" icon="plug">
    Attach Tempo, Loki, Prometheus, or Jaeger on a project.
  </Card>
