...
<Steps titleSize="h4">
  <Step title="Access import">
    ...
    <Frame>
        <img src="/images/dashboard-import-cta.png" alt="Import Layout button in the Dashboards Explorer" />
    </Frame>
  ...
  <Step title="Upload your dashboard JSON">
    ...
    <Frame>
        <img src="/images/dashboard-import-popup.png" alt="Import Board Layout dialog with a file upload interface" />
    </Frame>
