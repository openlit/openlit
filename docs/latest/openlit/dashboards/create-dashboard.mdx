...
<Steps titleSize="h4">
  <Step title="Create a new dashboard">
    <Frame>
      <img src="/images/create-dashboard-form.png" alt="Create a new dashboard or folder form" />
    </Frame>
  ...
  <Step title="Add your first widget">
    <Frame>
      <img src="/images/dashboard-empty.png" alt="Empty dashboard canvas with a Create Your First Widget button" />
    </Frame>
    1. Click **Create Your First Widget** button on the empty dashboard
    2. You'll see a **"Select a Widget"** popup with two options:
      <Frame>
        <img src="/images/dashboard-select-existing-widget-popup.png" alt="Select a Widget popup showing existing pre-built widgets" />
      </Frame>
       ...
       <Frame>
        <img src="/images/dashboard-select-new-widget-popup.png" alt="Create New Widget option in the Select a Widget popup" />
      </Frame>
  </Step>
  ...
  <Step title="Configure widget">
    ...
    **General Tab**
    <Frame>
        <img src="/images/dashboard-widget-configuration-general.png" alt="Widget configuration panel General tab" />
    </Frame>
    ...
    **Query Tab**
    <Frame>
        <img src="/images/dashboard-widget-configuration-query.png" alt="Widget configuration panel Query tab with a SQL editor" />
    </Frame>
  ...
  <Step title="Save your widget">
    ...
    <Frame>
        <img src="/images/dashboard-widget-created.png" alt="Dashboard canvas showing the newly created widget" />
    </Frame>
  </Step>
