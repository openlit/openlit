...
[Prompt Hub](/latest/openlit/prompts-experiments/prompt-hub) manages prompts as versioned artifacts with variable substitution and full history, [OpenGround](/latest/openlit/prompts-experiments/openground) lets you test a prompt across multiple models side-by-side before shipping, and every prompt version is linked back to the traces and evaluation results it produced in production.
...
<CardGroup cols={3}>
  ...
  <Card title="OpenGround" href="/latest/openlit/prompts-experiments/openground" icon='flask'>
