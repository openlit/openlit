...
| `gen_ai.usage.prompt_tokens`      | Number of prompt tokens processed.         | `1`   | Counter     | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.system`, `gen_ai.environment`, `gen_ai.operation.name`, `gen_ai.request.model` |
| `gen_ai.usage.completion_tokens`  | Number of completion tokens processed.     | `1`   | Counter     | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.system`, `gen_ai.environment`, `gen_ai.operation.name`, `gen_ai.request.model` |
...
| Metric Name                         | Description                              | Unit       | Type      | Attributes                                                            |
|-------------------------------------|------------------------------------------|------------|-----------|-----------------------------------------------------------------------|
| `gpu.utilization_percentage`        | GPU Utilization in percentage            | `percent`  | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.enc.utilization_percentage`    | GPU encoder Utilization in percentage    | `percent`  | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.dec.utilization_percentage`    | GPU decoder Utilization in percentage    | `percent`  | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.temperature`                   | GPU Temperature in Celsius               | `°C`       | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.fan_speed`                     | GPU Fan Speed (0-100) as an integer      | Integer    | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.memory.available`              | Available GPU Memory in MB               | `MB`       | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.memory.total`                  | Total GPU Memory in MB                   | `MB`       | Histogram | `telemetry.sdk.ydk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.memory.used`                   | Used GPU Memory in MB                    | `MB`       | Histogram | `telemetry.sdk.name`, `gen_ai.application_tation_name`, `gen_ai.environment` |
| `gpu.memory.free`                   | Free GPU Memory in MB                    | `MB`       | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.power.draw`                    | GPU Power Draw in Watts                  | `Watt`     | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
| `gpu.power.limit`                   | GPU Power Limit in Watts                 | `Watt`     | Histogram | `telemetry.sdk.name`, `gen_ai.application_name`, `gen_ai.environment` |
