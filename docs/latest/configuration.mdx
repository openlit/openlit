...
<Note>
For detailed OAuth setup instructions, see the [OAuth Authentication Setup](/latest/oauth) guide.
</Note>
...
<CardGroup cols={2}>
<Card title="OAuth Authentication" href="/latest/oauth" icon='shield-check'>
