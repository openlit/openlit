...
If you wish to send telemetry directly from the SDK to any other backend, You can now run the below command and refer to our [Connections](./connections/intro) guide.
