...
<Tabs>
  ...
  <Tab title="Improve" icon="arrow-trend-up">
    ...
    - **Online LLM evaluation** - [LLM-as-a-judge](/latest/openlit/evaluations/llm-as-a-judge) runs automatically on your live traces in production. Use a chat model or [TypeSafe Jev](/latest/openlit/evaluations/evaluators#typesafe-jev-judge) as the judge. Create custom evaluators with your own scoring criteria and quality gates.
