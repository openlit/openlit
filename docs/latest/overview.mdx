...
---
OpenLIT is an open-source AI intelligence platform that helps teams understand what AI agents are doing, measure their performance, and improve them in production. 
...
<Tabs>
  ...
  <Tab title="Manage" icon="sliders">
    <video
      ...
      alt="Demo of Fleet Hub managing OpenTelemetry collectors"
    >
    </video>
  ...
  <Tab title="Otter" icon="message-bot">
    <img src="/images/otter.svg" width="60" className="mb-4" alt="Otter, the OpenLIT AI chat copilot" />
...
<AccordionGroup>
  <Accordion title="What is OpenLIT?">
    OpenLIT is an open-source AI observability platform. It traces LLM and agent calls via OpenTelemetry, tracks cost and token usage, runs automated evaluations, and manages prompts - all self-hostable.
  </Accordion>
  ...
  <Accordion title="Does OpenLIT require code changes to instrument my app?">
    No. OpenLIT's SDK auto-instruments 90+ LLMs, agent frameworks, and vector databases with zero code changes, and the [Controller](/latest/controller/overview) can instrument running services at the infrastructure level via eBPF.
  </Accordion>
