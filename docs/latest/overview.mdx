...
<Tabs>
  <Tab title="Observe" icon="bars-staggered">
    <video
      ...
      src="/images/observe-overview.mp4"
  ...
  <Tab title="Develop" icon="code-branch">
    <video
      ...
      controls
      className="w-full aspect-video rounded-xl"
      src="/images/prompts-overview.mp4"
  ...
  <Tab title="Coding Agents" icon="laptop-code">
    <video
      ...
      controls
      className="w-full aspect-video rounded-xl"
      src="/images/coding-agents-overview.mp4"
      alt="Demo of coding agent observability for Claude Code, Cursor, Codex, and OpenCode"
    >
    </video>

    Coding agent observability for Claude Code, Cursor, Codex, and OpenCode. Understand token consumption, AI spend, and developer productivity across your entire engineering team:
    ...
    - **AI spend visibility** - See exactly how much each developer, team, and project spends on AI coding tools. Break down cost by model and vendor across Claude Code, Cursor, Codex, and OpenCode in one place.
  ...
  <Tab title="Improve" icon="arrow-trend-up">
    <video
      ...
      controls
      className="w-full aspect-video rounded-xl"
      src="/images/evaluations-overview.mp4"
  ...
  <Tab title="Manage" icon="sliders">
    <video
      ...
      controls
      className="w-full aspect-video rounded-xl"
      src="/images/secrets-overview.mp4"
