...
<CardGroup cols={2}>
  <Card title="Quickstart" href="/latest/sdk/quickstart" icon='bolt'>
    Get Started with monitoring your LLM Applications in 2 simple steps
  </Card>
  <Card title="Instrumentations" href="/latest/operator/instrumentations/overview" icon='circle-nodes'>
