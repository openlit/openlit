...
**SQLCommenter Example:**

When `enable_sqlcommenter` is enabled, queries are automatically modified to include trace context:
...
This enables correlation between application traces and database logs (e.g., `pg_stat_statements`, `auto_explain`).
