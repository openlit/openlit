---
title: 'Overview'
description: 'Zero-code AI Observability, Evaluations and Guardrails'
---

The OpenLIT SDK is an **open-source**, **OpenTelemetry-native** framework 
that enables complete AI application and agent observability **without any zero code changes**. 

OpenLIT also includes upstream OpenTelemetry instrumentations for HTTP frameworks, clients,
and system components, providing **end-to-end visibility for your entire AI stack**.

## Goals

- **Zero Code Instrumentation** - Enable complete observability for your AI applications **without any code changes**.

- **OpenTelemetry Native** - Built on OpenTelemetry standards for seamless integration with existing observability stacks like Grafana.

- **Drop-in Replacement** - If you are already using `opentelemetry-instrument`, simply replace with `openlit-instrument` to get the same functionality plus AI Observability capabilities.

- **Complete Stack Coverage** - AI instrumentations + upstream OpenTelemetry instrumentations.

- **End-to-End Distributed Tracing** - Complete visibility: HTTP requests → framework routing → database queries → LLM calls → tool usage → responses

- **AI-Specific Features** - Real-time cost tracking, token usage monitoring, AI evaluations (hallucination, bias, toxicity).

## Adopt OpenTelemetry for AI Apps in minutes​

Get complete visibility into your LLM applications and AI Agents. 
Track token usage, monitor agent workflows, measure response times, and
debug AI framework interactions - all without touching your code.
...
<CardGroup cols={2}>
  <Card title="Python" icon="python">    
    Complete auto-instrumentation with automatic dependency detection. CLI supports all Python AI applications without code changes.
  </Card>
  <Card title="TypeScript/JavaScript" icon="node-js">
    **✅ SDK Integration**
    
    Full SDK support for Node.js applications with TypeScript and JavaScript.
  </Card>
</CardGroup>
...
Both approaches provide identical observability: **distributed tracing**, **cost monitoring**, **performance metrics**, and **AI evaluations**.

## Getting started
Select from the following guides to learn more about how to use OpenLIT:

<CardGroup cols={2}>
  <Card title="Quickstart: LLM Observability" href="/latest/sdk/quickstart" icon='bolt'>
  ...
  <Card title="Destinations" href="/latest/sdk/destinations/intro" icon='link'>
