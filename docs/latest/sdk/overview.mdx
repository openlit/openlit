...
OpenLIT provides comprehensive model performance tracking, real-time cost monitoring, hallucination detection, and AI evaluations. It includes upstream OpenTelemetry instrumentations for HTTP frameworks, clients, and system components, delivering **complete visibility across your entire AI infrastructure**.
...
- **Advanced LLM Monitoring** - Real-time cost tracking, token usage optimization, performance monitoring, and AI evaluations (hallucination detection, bias detection, toxicity screening).

## OTel-native AI observability in minutes

Get complete visibility into your production LLM applications and agentic AI systems. 
Monitor model performance, track token costs, detect hallucinations, optimize latency, and
debug AI framework interactions with zero code changes. Perfect for enterprise AI reliability and compliance.
...
<CardGroup cols={2}>
  <Card title="Python" icon="python">    
    Complete AI observability with automatic dependency detection. Zero-code CLI instrumentation for production Python LLM applications with real-time performance monitoring.
  </Card>
  <Card title="TypeScript/JavaScript" icon="node-js">
    **✅ SDK Integration**
    
    Full LLM monitoring support for Node.js applications with comprehensive token usage tracking and cost optimization.
  </Card>
</CardGroup>
...
Both approaches provide enterprise-grade observability: **distributed tracing**, **real-time cost tracking**, **latency monitoring**, **token usage optimization**, and **AI evaluations** (hallucination detection, bias screening, toxicity analysis).

## Getting started
Select from the following guides to learn more about production AI monitoring:

<CardGroup cols={2}>
  <Card title="Quickstart: LLM Observability" href="/latest/sdk/quickstart-observability" icon='bolt'>
  ...
  <Card title="Deploy OpenLIT Platform" href="/latest/installation" icon='circle-down'>
    Deployment options for scalable LLM monitoring infrastructure
  </Card>
  <Card title="Observability Destinations" href="/latest/sdk/destinations/overview" icon='link'>
