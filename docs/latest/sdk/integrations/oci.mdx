...
description: 'OpenLIT brings AI observability to Oracle Cloud Infrastructure Generative AI via OpenTelemetry, tracing OCI SDK and LangChain chat, text, and embedding calls.'
