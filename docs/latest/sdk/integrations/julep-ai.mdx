...
description: 'Enable AI observability for agents built with Julep AI through OpenTelemetry auto-instrumentation, tracking performance and operation stats automatically.'
