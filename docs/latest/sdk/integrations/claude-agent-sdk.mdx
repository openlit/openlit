---
title: 'Monitor Claude Agent SDK using OpenTelemetry'
description: "OpenLIT auto-instruments Anthropic's Claude Agent SDK via OpenTelemetry, adding AI observability with tracing across agent runs, tool calls, and LLM calls."
sidebarTitle: 'Claude Agent SDK'
---

import IntegrationMethods from '/snippets/integration-methods.mdx';

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI agents built using the Claude Agent SDK (Anthropic). This includes tracking agent runs, tool calls, LLM interactions, and how users interact with the application.
...
- Claude Agent SDK Python client >= 0.0.1 
