...
description: "OpenLIT brings AI observability to AssemblyAI's speech and audio models via OpenTelemetry, tracking performance, cost tracking, and voice input settings."
