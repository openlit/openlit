...
description: 'Add OpenTelemetry auto-instrumentation to LlamaIndex retrieval and query pipelines for AI observability into indexing and query engine stats.'
