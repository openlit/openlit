...
description: 'OpenLIT auto-instruments Azure AI Inference models through OpenTelemetry, delivering AI observability with cost tracking, token usage, and performance data.'
