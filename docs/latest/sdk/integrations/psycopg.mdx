...
description: 'OpenLIT auto-instruments psycopg3 PostgreSQL queries with OpenTelemetry, tracing query performance, transactions, and pgvector similarity search.'
