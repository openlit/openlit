...
description: 'OpenLIT auto-instruments Featherless models (via the OpenAI SDK) with OpenTelemetry, enabling AI observability with cost tracking and token usage monitoring.'
