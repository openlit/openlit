---
title: 'Monitor LangGraph using OpenTelemetry'
description: 'Trace LangGraph agent workflows and graph execution with OpenTelemetry auto-instrumentation for AI observability into tool usage and state transitions.'
