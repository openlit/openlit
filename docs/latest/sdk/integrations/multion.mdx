...
description: 'Monitor autonomous browser agents built with MultiOn using OpenTelemetry auto-instrumentation, delivering AI observability into agent operation stats.'
