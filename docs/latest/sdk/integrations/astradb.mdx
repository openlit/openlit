...
description: 'OpenLIT auto-instruments AstraDB as a vector store using OpenTelemetry, providing AI observability with tracing into performance and operation stats.'
