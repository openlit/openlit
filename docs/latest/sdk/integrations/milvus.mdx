...
description: 'Monitor Milvus vector database operations behind LLM apps using OpenTelemetry auto-instrumentation, gaining AI observability into query performance.'
sidebarTitle: 'Milvus'
---
