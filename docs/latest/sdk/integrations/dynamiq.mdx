...
description: 'OpenLIT auto-instruments AI agents built with Dynamiq through OpenTelemetry, providing AI observability and tracing into agent performance and operations.'
