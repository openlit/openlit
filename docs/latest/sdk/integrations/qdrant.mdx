...
description: 'OpenLIT auto-instruments Qdrant vector database operations with OpenTelemetry, delivering AI observability into query performance and operation stats.'
sidebarTitle: 'Qdrant'
---
