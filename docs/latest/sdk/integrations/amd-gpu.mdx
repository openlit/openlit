...
description: 'OpenLIT uses OpenTelemetry to deliver AI observability for AMD GPUs, tracking utilization, temperature, memory usage, and power consumption metrics.'
