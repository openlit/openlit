...
description: 'OpenLIT auto-instruments AI agents built with ControlFlow via OpenTelemetry, adding AI observability and tracing into performance and operation stats.'
