...
description: 'OpenLIT auto-instruments AI applications built with DSPy using OpenTelemetry, adding AI observability and tracing into pipeline performance and operations.'
sidebarTitle: 'DSPy'
---
