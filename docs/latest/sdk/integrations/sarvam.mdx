...
description: 'OpenLIT brings AI observability to Sarvam AI LLM applications via OpenTelemetry auto-instrumentation, tracking performance, token usage, and cost tracking.'
