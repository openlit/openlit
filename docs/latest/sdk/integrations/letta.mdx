...
description: 'Monitor AI agents built with Letta using OpenTelemetry auto-instrumentation, capturing AI observability data on performance and operation stats.'
sidebarTitle: 'Letta'
---
