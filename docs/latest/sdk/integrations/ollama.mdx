...
description: 'OpenLIT brings AI observability to Ollama LLM apps via OpenTelemetry auto-instrumentation, tracing performance and usage across Python and TypeScript SDKs.'
sidebarTitle: 'Ollama'
---
