...
description: 'Track FireCrawl web crawling agents with OpenTelemetry auto-instrumentation for AI observability into crawl performance and operation stats.'
...
- FireCrawl TypeScript SDK (`@mendable/firecrawl-js`) `>= 1.0.0 < 4`
