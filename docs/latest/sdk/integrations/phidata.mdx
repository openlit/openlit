...
description: 'OpenLIT adds AI observability to Phidata AI agents via OpenTelemetry auto-instrumentation, tracing agent performance and operation stats automatically.'
