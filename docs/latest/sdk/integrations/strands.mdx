---
title: 'Monitor Strands Agents using OpenTelemetry'
description: 'Trace Strands Agents SDK applications with OpenTelemetry auto-instrumentation for AI observability into agent invocations, tool calls, and chat completions.'
sidebarTitle: 'Strands Agents'
---

import IntegrationMethods from '/snippets/integration-methods.mdx';

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor AI agents built using Strands Agents SDK. This includes tracking agent invocations, tool calls, chat completions, and how users interact with the application.
...
- Strands Agents Python SDK >= 0.1.0 
- @strands-agents/sdk Typescript SDK >= 0.1.0 
...
<Card
    title="Running in Kubernetes? Try the OpenLIT Controller"
