...
description: 'OpenLIT auto-instruments AI agents built with CrewAI via OpenTelemetry, providing AI observability and tracing into multi-agent performance and operations.'
sidebarTitle: 'CrewAI'
---
