---
title: 'Monitor Mistral AI using OpenTelemetry'
description: 'Track LLM apps built on Mistral AI models with OpenTelemetry auto-instrumentation for AI observability, covering tokens, cost, and performance.'
sidebarTitle: 'Mistral'
---

import IntegrationMethods from '/snippets/integration-methods.mdx';

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using models from Mistral AI. This includes tracking performance, token usage, costs, and how users interact with the application.
...
- Mistral AI Python SDK client `>= 1.0.0`
- Mistral AI TypeScript/JavaScript SDK client `>= 1.0.0`
