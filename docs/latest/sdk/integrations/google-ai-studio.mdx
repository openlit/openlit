---
title: 'Monitor Google AI Studio using OpenTelemetry'
description: "Track LLM apps built with Google AI Studio's Gemini models via OpenTelemetry auto-instrumentation, covering AI observability, tokens, and cost tracking."
sidebarTitle: 'Google AI Studio'
---

import IntegrationMethods from '/snippets/integration-methods.mdx';

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using models from Google AI Studio (Gemini). This includes tracking performance, token usage, costs, and how users interact with the application.
...
- Google Generative AI Python SDK `>= 1.3.0`
- Google Generative AI TypeScript/JavaScript SDK `>= 0.1.0`
