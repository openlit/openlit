...
description: 'OpenLIT auto-instruments AutoGen (AG2) agents via OpenTelemetry, giving you AI observability and tracing into multi-agent performance and operations.'
