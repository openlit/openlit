...
description: 'Track the mem0 memory layer for LLM apps with OpenTelemetry auto-instrumentation, providing AI observability into memory read/write performance.'
sidebarTitle: 'mem0'
---
