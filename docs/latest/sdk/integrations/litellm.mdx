...
description: "Get AI observability into LLM apps routed through LiteLLM's unified gateway via OpenTelemetry auto-instrumentation, tracking performance and operation stats."
