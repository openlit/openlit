...
description: 'OpenLIT auto-instruments Google Vertex AI LLM applications with OpenTelemetry, providing AI observability into performance, token usage, and cost tracking.'
