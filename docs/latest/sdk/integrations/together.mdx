---
title: 'Monitor Together AI using OpenTelemetry'
description: 'Monitor Together AI LLM applications with OpenTelemetry auto-instrumentation, gaining AI observability into performance, token usage, and cost tracking.'
sidebarTitle: 'Together AI'
---

import IntegrationMethods from '/snippets/integration-methods.mdx';

OpenLIT uses OpenTelemetry Auto-Instrumentation to help you monitor LLM applications built using models from Together AI. This includes tracking performance, token usage, costs, and how users interact with the application.
...
- Together AI Python SDK `>= 1.3.5`
- Together AI TypeScript/JavaScript SDK `>= 0.1.0`
