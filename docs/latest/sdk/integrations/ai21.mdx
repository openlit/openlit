...
description: 'OpenLIT auto-instruments AI21 models with OpenTelemetry for AI observability, capturing performance, token usage, and cost tracking across your LLM calls.'
sidebarTitle: 'AI21'
---
