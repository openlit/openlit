...
description: 'Trace Pydantic AI agents with OpenTelemetry auto-instrumentation for AI observability into agent performance and operation stats, with zero code changes.'
