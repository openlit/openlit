...
description: "Gain AI observability into LLM apps powered by Groq's fast inference API with OpenTelemetry auto-instrumentation, tracking tokens and cost."
sidebarTitle: 'Groq'
---
...
- Groq TypeScript/JavaScript SDK client `>= 0.5.0`
