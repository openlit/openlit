...
description: 'OpenLIT auto-instruments Amazon Bedrock models using OpenTelemetry, offering AI observability with cost tracking, token usage, and performance tracing.'
