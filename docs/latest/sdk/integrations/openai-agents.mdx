...
description: 'Trace AI agents built on the OpenAI Agents SDK with OpenTelemetry auto-instrumentation for AI observability into agent performance and operation stats.'
