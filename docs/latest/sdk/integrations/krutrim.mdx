...
description: 'Track LLM apps built on OLA Krutrim models, accessed via the OpenAI SDK, using OpenTelemetry auto-instrumentation for AI observability and cost tracking.'
