...
description: 'Apply OpenTelemetry auto-instrumentation for AI evaluation of LLM apps validated with the Guardrails AI library, tracking performance and operation stats.'
