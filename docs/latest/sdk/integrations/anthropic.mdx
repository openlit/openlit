...
description: 'OpenLIT auto-instruments Anthropic Claude with OpenTelemetry, enabling AI observability with cost tracking, token usage, and performance tracing for LLM apps.'
sidebarTitle: 'Anthropic'
---

import IntegrationMethods from '/snippets/integration-methods.mdx';

OpenLIT uses OpenTelemetry instrumentation to help you monitor LLM applications built using Anthropic models. This includes tracking performance, token usage, costs, and how users interact with the application.

The integration is compatible with:
- Anthropic Python SDK client `>= 0.21.0`
- Anthropic Typescript SDK client `>= 0.21.0`
- Anthropic Go SDK, via OpenLIT's `InstrumentedClient` wrapper
