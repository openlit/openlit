...
description: 'OpenLIT auto-instruments Cohere models using OpenTelemetry, delivering AI observability with cost tracking and token usage monitoring for LLM apps.'
sidebarTitle: 'Cohere'
---
...
- Cohere TypeScript/JavaScript SDK client `>= 7.0.0`
