...
<Steps>
  <Step title="Set up OpenLIT">
    Ensure you have an OpenLIT instance running. See [Installation](/latest/openlit/installation) for setup instructions.
  </Step>
  <Step title="Create an API Key">
    Navigate to **Settings > API Keys** in OpenLIT. Click **Create API Key** and save the key securely.
  </Step>
  <Step title="Create Rules">
    Set up rules with conditions and linked entities in the [Rule Engine](/latest/openlit/prompts-experiments/rule-engine/overview) UI.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Rule Engine Guide" href="/latest/openlit/prompts-experiments/rule-engine/overview" icon="gears">
