...
description: "Monitor NVIDIA and AMD GPUs with key metrics like usage, temperature, and power using OpenTelemetry"
---
...
<AccordionGroup>
  <Accordion title="Using the SDK">
    <Steps>
        ...
        To send metrics to other Observability tools, refer to the [Connections Guide](/latest/sdk/destinations/intro).
