---
title: 'Installation'
description: 'Self-host OpenLIT in your preferred environment'
icon: 'circle-down'
---
...
<CardGroup cols={2}>
  <Card
    ...
    href="/latest/installation#kubernetes"
  >
  ...
  <Card
    title="Docker"
    icon="docker"
    href="/latest/installation#docker"
  >
...
Deploy OpenLIT on your Kubernetes cluster using the [OpenLIT Helm chart](https://github.com/dokulabs/helm/tree/main/charts/doku) for a reliable and scalable solution.
<Steps>
...
<Steps>
  ...
  services:
    clickhouse:
      ...
      environment:
        CLICKHOUSE_PASSWORD: ${DOKU_DB_PASSWORD:-OPENLIT}   
    ...
    doku-ingester:
      ...
      environment:
        ...
        DOKU_DB_PASSWORD: ${DOKU_DB_PASSWORD:-OPENLIT}
      ports:
        - "9044:9044"           
      depends_on:
        - clickhouse
