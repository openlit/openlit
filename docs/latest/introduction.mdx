...
- [OpenLIT Operator](/latest/operator/overview) - Kubernetes operator that automatically injects instrumentation into AI applications without requiring code or image changes.
...
<CardGroup cols={2}>
  ...
  <Card title="Deploy OpenLIT" href="/latest/installation" icon='circle-down'>
