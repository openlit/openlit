...
The **Instrumentation Hub** is the dashboard page where you manage all Controller-discovered services. Once the Controller is running, navigate to **Instrumentation Hub** in the OpenLIT sidebar.
