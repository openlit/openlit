---
title: 'Dynatrace'
description: 'Connect Doku to Dynatrace'
---

<Frame>
  <img src="https://github.com/dokulabs/doku/blob/signoz/docs/images/dynatrace-dashboard-1.jpg?raw=true"  />
  <img src="https://github.com/dokulabs/doku/blob/signoz/docs/images/dynatrace-dashboard-2.jpg?raw=true" />
  <img src="https://github.com/dokulabs/doku/blob/signoz/docs/images/dynatrace-dsahboard-3.jpg?raw=true" />
</Frame>
...
connections:
  enabled: true                                 # Enable or Disable the Observability Platform, Example: true
    dynatrace:
      metricsUrl: <your-dynatrace-metrics-url>    # URL to the Dynatrace Metrics API
      logsUrl: <your-dynatrace-logs-url>          # URL to the Dynatrace Logs API
      apiKey: <your-dynatrace-api-key>            # API Key of the Dynatrace Account
```
