...
<Frame>
  <img src="https://github.com/dokulabs/doku/blob/signoz/docs/images/signoz-dashboard-1.jpg?raw=true"  />
  <img src="https://github.com/dokulabs/doku/blob/signoz/docs/images/signoz-dashboard-2.jpg?raw=true" />
</Frame>
...
connections:
  enabled: true                          # Enable or Disable the Observability Platform, Example: true
    signoz:
      url: <your-signoz-metrics-url>     # URL to the SigNoz Logs API
      apiKey: <your-signoz-api-key>      # API Key from SigNoz
```
