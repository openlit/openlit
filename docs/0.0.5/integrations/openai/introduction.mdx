...
- [Chat completions](/0.0.5/integrations/openai/examples/chat)
- [Image Create](/0.0.5/integrations/openai/examples/image#create-image) and [Image Variations](/0.0.5/integrations/openai/examples/image#create-image-variation)
- [Audio Speech Create](/0.0.5/integrations/openai/examples/audio)
- [Embeddings](/0.0.5/integrations/openai/examples/embeddings)
- [Fine Tunings](/0.0.5/integrations/openai/examples/fine-tuning)
- [Completions](/0.0.5/integrations/openai/examples/completions)
