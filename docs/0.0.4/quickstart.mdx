      ...
      <Tab title="Python">
        <Steps>
          ...
          <Step title="Add the following two lines to your application code:">
            ...
            Refer to the `dokumetry` [Python SDK repository](https://github.com/dokulabs/dokumetry-python) or the [DokuMetry Docs](/0.0.4/dokumetry/python/intro) for more advanced configurations and use cases.
          </Step>
        </Steps>
      </Tab>
      <Tab title="NodeJS">
...
<Card title="Integrations" href="/0.0.4/integrations/intro" icon='connectdevelop'>
