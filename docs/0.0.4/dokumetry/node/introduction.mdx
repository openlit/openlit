...
- [Chat completions](/0.0.4/dokumetry/node/examples/openai/chat)
- [Image Create](/0.0.4/dokumetry/node/examples/openai/image#create-image) and [Image Variations](/0.0.4/dokumetry/node/examples/openai/image#create-image-variation)
- [Audio Speech Create](/0.0.4/dokumetry/node/examples/openai/audio)
- [Embeddings](/0.0.4/dokumetry/node/examples/openai/embeddings)
- [Fine Tunings](/0.0.4/dokumetry/node/examples/openai/fine-tuning)
- [Completions](/0.0.4/dokumetry/node/examples/openai/chatCompletions)
...
- [Chat](/0.0.4/dokumetry/node/examples/cohere/chat)
- [Generate](/0.0.4/dokumetry/node/examples/cohere/generate)
- [Summarize](/0.0.4/dokumetry/node/examples/cohere/summarize)
- [Embed](/0.0.4/dokumetry/node/examples/cohere/embed)
...
- [Completions](/0.0.4/dokumetry/node/examples/anthropic/anthropic-completions)
