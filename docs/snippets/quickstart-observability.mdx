...
<Frame>
  <img src="/images/docs-ai-observability-trace.png" alt="Agent chat and span attributes for a LangGraph workflow in OpenLIT Telemetry" />
</Frame>
...
flowchart TB;
    subgraph " "
        ...
        subgraph " "
            direction LR;
            OpenLIT_SDK[OpenLIT SDK] -->|OTLP| Rec[OpenLIT OTLP receiver];
            Rec -->|Stores Data| ClickHouseDB[ClickHouse];
        end
        subgraph " "
            direction RL;
...
<Steps>
    <Step title="Deploy OpenLIT">
      <Steps>
        ...
        ```
        <Tip>
        Prefer Kubernetes, or already have ClickHouse running? See [Self-Host OpenLIT](/latest/openlit/installation) for Helm charts and other deployment options.
        </Tip>
        </Step>
      </Steps>
    </Step>
