...
<Steps>
  ...
  <Step title="Access Doku UI and Generate an API Key">
    ...
    <Tip>Alternatively, you can use the HTTP API to create your Doku API Key. For further details, take a look at the [API Reference](/0.1/api-reference/endpoint/api-keys/create) section.</Tip>
  </Step>
