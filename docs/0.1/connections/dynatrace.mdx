...
Make the following curl request to Doku to add a connection for Dynatrace. See more on the [Connections API](/0.1/api-reference/endpoint/connections/create)
