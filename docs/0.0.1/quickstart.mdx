...
<Steps>
  ...
  <Step title="Generate an API Key">
    With Doku running, the next step is to [generate an API key](/0.0.1/api-reference/endpoint/api-keys/create) for secure communication between your applications and Doku.
      ...
      <Tab title="Python">
        <Steps>
          ...
          <Step title="Add the following two lines to your application code:">
            ...
            Refer to the `dokumetry` [Python SDK repository](https://github.com/dokulabs/dokumetry-python) or the [DokuMetry Docs](/0.0.1/dokumetry/python/introduction) for more advanced configurations and use cases.
          </Step>
        </Steps>
      </Tab>
      <Tab title="NodeJS">
        <Steps>
          ...
          <Step title="Add the following two lines to your application code">
            ...
            Refer to the `dokumetry` [NodeJS SDK repository](https://github.com/dokulabs/dokumetry-node) or the [DokuMetry Docs](/0.0.1/dokumetry/node/intro) for more advanced configurations and use cases.
          </Step>
        </Steps>
      </Tab>
    </Tabs>
