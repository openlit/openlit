      ...
      <Tab title="NodeJS">
        <Steps>
          ...
          <Step title="Add the following two lines to your application code">
            ...
            Refer to the `dokumetry` [NodeJS SDK repository](https://github.com/dokulabs/dokumetry-node) or the [DokuMetry Docs](/0.0.1/dokumetry/node/introduction) for more advanced configurations and use cases.
          </Step>
        </Steps>
      </Tab>
    </Tabs>
