...
<Frame>
  <img src="https://github.com/dokulabs/doku/blob/grafana-cloud/docs/images/grafana-dashboard-1.jpg?raw=true"  />
  <img src="https://github.com/dokulabs/doku/blob/grafana-cloud/docs/images/grafana-dashboard-3.jpg?raw=true" />
</Frame>
...
<Accordion title="Dashboard">
    ...
    "panels": [
        ...
        "datasource": {
            ...
            "uid": "dbed68e2-974f-495c-9ed1-86b2e33253c1"
        },
        "gridPos": {
            "h": 4,
            "w": 11,
        ...
        "targets": [
            ...
            "format": "table",
            "rawQuery": true,
            "rawSql": "SELECT \"time\", applicationName, model, prompt, response, usageCost FROM doku WHERE $__timeFilter(time)",
            "refId": "A",
            "sql": {
                "columns": [
                {
    ...
    "uid": "cd0a92bf-7abe-427b-8e65-c61049be328e",
    "version": 7,
    "weekStart": ""
    }
    ```
