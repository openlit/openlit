  ...
  <Step title="Install Doku">
    <Steps>
      ...
      <Step title="Create a Doku Configuration file">
        ...
        <Info>
        As Doku does not have a built-in visualization UI yet, it is preferred that you set up the observabilityPlatform configuration within the [Doku Configuration file (`doku.yml`)](/0.0.1/configuration#observability-platform-configuration) file. 
