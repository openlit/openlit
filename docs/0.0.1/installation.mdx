...
<CardGroup cols={2}>
  <Card
    ...
    href="/0.0.1/installation#kubernetes"
  >
  ...
  <Card
    title="Docker"
    icon="docker"
    href="/0.0.1/installation#docker"
  >
  ...
  <Card
    title="Windows"
    icon="windows"
    href="/0.0.1/installation#windows"
  >
...
<Steps>
  ...
  ```shell shell
  helm install doku dokulabs/doku --version  0.0.7
  ```
  </Step>
</Steps>
  ...
  <Step title="Install Doku">
    <Steps>
      ...
      <Step title="Create a Doku Configuration file">
        ...
        <Info>
        As Doku does not have a built-in visualization UI yet, it is preferred that you set up the `observabilityPlatform` configuration within the [Doku Configuration file (`doku.yml`)](/0.0.1/configuration#connections-configuration) file. 
    ...
    <Tabs>
      <Tab title="Linux">
        <CodeGroup>
          ...
          ```shell arm64
          curl -O -L https://github.com/dokulabs/doku/releases/download/0.0.1/ingester-linux-arm64
          chmod +x ingester-linux-arm64
          ./ingester-linux-arm64 --config doku.yml
          ```

          ```shell arm
          curl -O -L https://github.com/dokulabs/doku/releases/download/0.0.1/ingester-linux-arm
          chmod +x ingester-linux-arm
          ./ingester-linux-arm --config doku.yml
          ```
          
          ```shell ppc64le
          curl -O -L https://github.com/dokulabs/doku/releases/download/0.0.1/ingester-linux-ppc64le
      ...
      <Tab title="Darwin">
        <CodeGroup>
            ```shell amd64
            curl -O -L https://github.com/dokulabs/doku/releases/download/0.0.1/ingester-darwin-amd64
            chmod +x ingester-darwin-amd64
            ./ingester-darwin-amd64 --config doku.yml
            ```

            ```shell arm64
            curl -O -L https://github.com/dokulabs/doku/releases/download/0.0.1/ingester-darwin-arm64
...
<Steps>
  ...
  <Step title="Install Doku in a Windows Host">
    <CodeGroup>
        ...
        ```shell 386
        invoke-WebRequest -Uri "https://github.com/dokulabs/doku/releases/download/0.0.1/ingester-windows-386" -OutFile "ingester.exe"
        .\ingester.exe --config doku.yml
        ```
    </CodeGroup>
  </Step>
