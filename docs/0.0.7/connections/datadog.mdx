...
Make the following curl request to Doku to add a connection for DataDog. See more on the [Connections API](/0.0.7/api-reference/endpoint/connections/create)
