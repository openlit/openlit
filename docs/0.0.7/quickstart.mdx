...
<Steps>
  ...
  <Step title="Access Doku Client UI and Generate an API Key">
    With Doku running, the next step is to Access the Doku Client UI and generate an API key for secure communication between your applications and Doku.
    1. Open your browser and go to Doku Client UI at `127.0.0.1:3000/login`
