...
<ResponseField name="retentionPeriod" type="String">
  The `retentionPeriod` field indicates how long the LLM Monitoring data will be stored before it is deleted. For example, you can specify a retention period of "6 months" to keep the data for six months before it is automatically removed.
