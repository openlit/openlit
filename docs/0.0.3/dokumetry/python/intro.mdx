...
- [Completions](/0.0.3/dokumetry/python/examples/openai/chatCompletions)
...
- [Summarize](/0.0.3/dokumetry/python/examples/cohere/summarize)
...
- [Completions](/0.0.3/dokumetry/python/examples/anthropic/completions)
