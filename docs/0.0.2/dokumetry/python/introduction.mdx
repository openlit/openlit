...
- [Chat completions](/0.0.2/dokumetry/python/examples/openai/chat)
- [Image Create](/0.0.2/dokumetry/python/examples/openai/image#create-image) and [Image Variations](/0.0.2/dokumetry/python/examples/openai/image#create-image-variation)
- [Audio Speech Create](/0.0.2/dokumetry/python/examples/openai/audio)
- [Embeddings](/0.0.2/dokumetry/python/examples/openai/embeddings)
- [Fine Tunings](/0.0.2/dokumetry/python/examples/openai/fine-tuning)
- [Completions](/0.0.2/dokumetry/python/examples/openai/completions)
...
- [Chat](/0.0.2/dokumetry/python/examples/cohere/chat)
- [Generate](/0.0.2/dokumetry/python/examples/cohere/generate)
- [Summarize](/0.0.2/dokumetry/python/examples/cohere/co-summarize)
- [Embed](/0.0.2/dokumetry/python/examples/cohere/embed)
...
- [Completions](/0.0.2/dokumetry/python/examples/anthropic/anthropic-completions.mdx)
