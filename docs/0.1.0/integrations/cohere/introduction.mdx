...
- [Chat](/0.1.0/integrations/cohere/examples/chat)
- [Generate](/0.1.0/integrations/cohere/examples/generate)
- [Summarize](/0.1.0/integrations/cohere/examples/summarize)
- [Embed](/0.1.0/integrations/cohere/examples/embed)
