...
Make the following curl request to Doku to add a connection for SigNoz. See more on the [Connections API](/0.1.0/api-reference/endpoint/connections/create)
