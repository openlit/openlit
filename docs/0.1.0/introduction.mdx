...
Find detailed instructions at the [DokuMetry SDK Documentation](https://github.com/dokulabs/dokumetry-node).

### The Doku Ingester: Your Data Processing Workhorse

Upon SDK setup, data from your LLM operations is automatically collected. The DokuMetry SDKs transmit this usage data over HTTP in the background to the [Doku Ingester](https://github.com/dokulabs/doku/tree/main/src/ingester#readme).
...
- **Secure Storage**: All processed information is securely stored in Clickhouse, providing you with a scalable, time-series database that can handle large volumes of observability data.

You have the choice to set up a fresh Clickhouse instance or connect Doku to your existing one. Whichever path you choose, your data resides within your control, reinforcing your data security and operational compliance.
...
<CardGroup cols={3}>
  <Card
      title="OpenAI"
      href="/0.1.0/integrations/openai/introduction"
      icon={
  ...
  <Card
      title="Cohere"
      href="/0.1.0/integrations/cohere/introduction"
      icon={
  ...
  <Card
      title="Anthropic"
      href="/0.1.0/integrations/anthropic/introduction"
      icon={
...
<CardGroup cols={2}>
<Card title="Quickstart" href="/0.1.0/quickstart" icon='bolt'>
Get Started with monitoring your LLM Applications in 2 simple steps
</Card>
<Card title="Integrations" href="/0.1.0/integration/introduction" icon='circle-nodes'>
Integrate your LLM Provider with Doku 
</Card>
<Card title="Installation" href="/0.1.0/installation" icon='circle-down'>
